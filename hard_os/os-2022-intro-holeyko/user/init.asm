...
int main(void) {
  ...
  12:	99250513          	addi	a0,a0,-1646 # 9a0 <loop+0xc>
  ...
  3a:	97290913          	addi	s2,s2,-1678 # 9a8 <loop+0x14>
  3e:	854a                	mv	a0,s2
  ...
  6e:	98e50513          	addi	a0,a0,-1650 # 9f8 <loop+0x64>
  ...
  8c:	91850513          	addi	a0,a0,-1768 # 9a0 <loop+0xc>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	90650513          	addi	a0,a0,-1786 # 9a0 <loop+0xc>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	91450513          	addi	a0,a0,-1772 # 9c0 <loop+0x2c>
  ...
  d2:	90a50513          	addi	a0,a0,-1782 # 9d8 <loop+0x44>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	90250513          	addi	a0,a0,-1790 # 9e0 <loop+0x4c>
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 476:	60650513          	addi	a0,a0,1542 # a78 <digits>
 47a:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 536:	4eec8c93          	addi	s9,s9,1262 # a20 <loop+0x8c>
      } else if (c == 'p') {
 ...
 544:	538b8b93          	addi	s7,s7,1336 # a78 <digits>
 ...
 66a:	3b298993          	addi	s3,s3,946 # a18 <loop+0x84>
        while (*s != 0) {
 66e:	85ee                	mv	a1,s11
...
00000000000008a6 <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000008c2 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 8c4:	59d1                	li	s3,-12
  li s4, 123
 8c6:	07b00a13          	li	s4,123
  li s5, -1234
 8ca:	b2e00a93          	li	s5,-1234
  li s6, 12345
 8ce:	6b0d                	lui	s6,0x3
 8d0:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2019>
  li s7, -123456
 8d4:	7b89                	lui	s7,0xfffe2
 8d6:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0da0>
  li s8, 1234567
 8da:	0012dc37          	lui	s8,0x12d
 8de:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c667>
  li s9, -12345678
 8e2:	ff43acb7          	lui	s9,0xff43a
 8e6:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438e92>
  li s10, 123456789
 8ea:	075bdd37          	lui	s10,0x75bd
 8ee:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbcf5>
  li s11, -1234567890
 8f2:	b66a0db7          	lui	s11,0xb66a0
 8f6:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed0e>
#ifdef SYS_dump
  li a7, SYS_dump
 8fa:	48d9                	li	a7,22
  ecall
...
0000000000000902 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 902:	80000937          	lui	s2,0x80000
 906:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefdf>
  li s3, -2147483648
 908:	800009b7          	lui	s3,0x80000
  li s4, 1337
 90c:	53900a13          	li	s4,1337
  li s5, 2020
 910:	7e400a93          	li	s5,2020
  li s6, 3234
 914:	6b05                	lui	s6,0x1
 916:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x22a>
  li s7, 3235
 91a:	6b85                	lui	s7,0x1
 91c:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x22b>
  li s8, 3236
 920:	6c05                	lui	s8,0x1
 922:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x22c>
  li s9, 3237
 926:	6c85                	lui	s9,0x1
 928:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x22d>
  li s10, 3238
 92c:	6d05                	lui	s10,0x1
 92e:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x22e>
  li s11, 3239
 932:	6d85                	lui	s11,0x1
 934:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x22f>
#ifdef SYS_dump
  li a7, SYS_dump
 938:	48d9                	li	a7,22
  ecall
...
0000000000000940 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
000000000000095c <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 962:	4ae5                	li	s5,25
  li s6, 36
 964:	02400b13          	li	s6,36
  li s7, 49
 968:	03100b93          	li	s7,49
  li s8, 64
 96c:	04000c13          	li	s8,64
  li s9, 81
 970:	05100c93          	li	s9,81
  li s10, 100
 974:	06400d13          	li	s10,100
  li s11, 121
 978:	07900d93          	li	s11,121
  li a7, SYS_write
 97c:	48c1                	li	a7,16
  ecall
 97e:	00000073          	ecall
...
0000000000000984 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 984:	53900913          	li	s2,1337
  mv a2, a1
 988:	862e                	mv	a2,a1
  li a1, 2
 98a:	4589                	li	a1,2
