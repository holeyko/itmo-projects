...
void ls(char *path) {
 ...
 12c:	a8850513          	addi	a0,a0,-1400 # bb0 <loop+0x3e>
 ...
 16a:	a1a58593          	addi	a1,a1,-1510 # b80 <loop+0xe>
 16e:	4509                	li	a0,2
 ...
 180:	a1c58593          	addi	a1,a1,-1508 # b98 <loop+0x26>
 184:	4509                	li	a0,2
 ...
 1b2:	a1250513          	addi	a0,a0,-1518 # bc0 <loop+0x4e>
 ...
 1f6:	9e6a0a13          	addi	s4,s4,-1562 # bd8 <loop+0x66>
          printf("ls: cannot stat %s\n", buf);
 1fa:	00001a97          	auipc	s5,0x1
 1fe:	99ea8a93          	addi	s5,s5,-1634 # b98 <loop+0x26>
...
int main(int argc, char *argv[]) {
 ...
 2c0:	92c50513          	addi	a0,a0,-1748 # be8 <loop+0x76>
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 654:	60050513          	addi	a0,a0,1536 # c50 <digits>
 658:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 714:	4e8c8c93          	addi	s9,s9,1256 # bf8 <loop+0x86>
      } else if (c == 'p') {
 ...
 722:	532b8b93          	addi	s7,s7,1330 # c50 <digits>
 ...
 848:	3ac98993          	addi	s3,s3,940 # bf0 <loop+0x7e>
        while (*s != 0) {
 84c:	85ee                	mv	a1,s11
...
0000000000000a84 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000aa0 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 aa2:	59d1                	li	s3,-12
  li s4, 123
 aa4:	07b00a13          	li	s4,123
  li s5, -1234
 aa8:	b2e00a93          	li	s5,-1234
  li s6, 12345
 aac:	6b0d                	lui	s6,0x3
 aae:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2019>
  li s7, -123456
 ab2:	7b89                	lui	s7,0xfffe2
 ab4:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0da0>
  li s8, 1234567
 ab8:	0012dc37          	lui	s8,0x12d
 abc:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c667>
  li s9, -12345678
 ac0:	ff43acb7          	lui	s9,0xff43a
 ac4:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438e92>
  li s10, 123456789
 ac8:	075bdd37          	lui	s10,0x75bd
 acc:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbcf5>
  li s11, -1234567890
 ad0:	b66a0db7          	lui	s11,0xb66a0
 ad4:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed0e>
#ifdef SYS_dump
  li a7, SYS_dump
 ad8:	48d9                	li	a7,22
  ecall
...
0000000000000ae0 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 ae0:	80000937          	lui	s2,0x80000
 ae4:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefdf>
  li s3, -2147483648
 ae6:	800009b7          	lui	s3,0x80000
  li s4, 1337
 aea:	53900a13          	li	s4,1337
  li s5, 2020
 aee:	7e400a93          	li	s5,2020
  li s6, 3234
 af2:	6b05                	lui	s6,0x1
 af4:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x52>
  li s7, 3235
 af8:	6b85                	lui	s7,0x1
 afa:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x53>
  li s8, 3236
 afe:	6c05                	lui	s8,0x1
 b00:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x54>
  li s9, 3237
 b04:	6c85                	lui	s9,0x1
 b06:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x55>
  li s10, 3238
 b0a:	6d05                	lui	s10,0x1
 b0c:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x56>
  li s11, 3239
 b10:	6d85                	lui	s11,0x1
 b12:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x57>
#ifdef SYS_dump
  li a7, SYS_dump
 b16:	48d9                	li	a7,22
  ecall
...
0000000000000b1e <dump2_test1_asm>:
#include "kernel/syscall.h"
...
0000000000000b3a <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 b40:	4ae5                	li	s5,25
  li s6, 36
 b42:	02400b13          	li	s6,36
  li s7, 49
 b46:	03100b93          	li	s7,49
  li s8, 64
 b4a:	04000c13          	li	s8,64
  li s9, 81
 b4e:	05100c93          	li	s9,81
  li s10, 100
 b52:	06400d13          	li	s10,100
  li s11, 121
 b56:	07900d93          	li	s11,121
  li a7, SYS_write
 b5a:	48c1                	li	a7,16
  ecall
 b5c:	00000073          	ecall
...
0000000000000b62 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 b62:	53900913          	li	s2,1337
  mv a2, a1
 b66:	862e                	mv	a2,a1
  li a1, 2
 b68:	4589                	li	a1,2
