...
void cat(int fd) {
  ...
  44:	98058593          	addi	a1,a1,-1664 # 9c0 <loop+0x6>
  48:	4509                	li	a0,2
  ...
  72:	96a58593          	addi	a1,a1,-1686 # 9d8 <loop+0x1e>
  76:	4509                	li	a0,2
...
int main(int argc, char *argv[]) {
 ...
 106:	8ee58593          	addi	a1,a1,-1810 # 9f0 <loop+0x36>
 10a:	4509                	li	a0,2
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 49c:	5d050513          	addi	a0,a0,1488 # a68 <digits>
 4a0:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 55c:	4b8c8c93          	addi	s9,s9,1208 # a10 <loop+0x56>
      } else if (c == 'p') {
 ...
 56a:	502b8b93          	addi	s7,s7,1282 # a68 <digits>
 ...
 690:	37c98993          	addi	s3,s3,892 # a08 <loop+0x4e>
        while (*s != 0) {
 694:	85ee                	mv	a1,s11
...
00000000000008cc <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000008e8 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 8ea:	59d1                	li	s3,-12
  li s4, 123
 8ec:	07b00a13          	li	s4,123
  li s5, -1234
 8f0:	b2e00a93          	li	s5,-1234
  li s6, 12345
 8f4:	6b0d                	lui	s6,0x3
 8f6:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x1e29>
  li s7, -123456
 8fa:	7b89                	lui	s7,0xfffe2
 8fc:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0bb0>
  li s8, 1234567
 900:	0012dc37          	lui	s8,0x12d
 904:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c477>
  li s9, -12345678
 908:	ff43acb7          	lui	s9,0xff43a
 90c:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ca2>
  li s10, 123456789
 910:	075bdd37          	lui	s10,0x75bd
 914:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbb05>
  li s11, -1234567890
 918:	b66a0db7          	lui	s11,0xb66a0
 91c:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669eb1e>
#ifdef SYS_dump
  li a7, SYS_dump
 920:	48d9                	li	a7,22
  ecall
...
0000000000000928 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 928:	80000937          	lui	s2,0x80000
 92c:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffedef>
  li s3, -2147483648
 92e:	800009b7          	lui	s3,0x80000
  li s4, 1337
 932:	53900a13          	li	s4,1337
  li s5, 2020
 936:	7e400a93          	li	s5,2020
  li s6, 3234
 93a:	6b05                	lui	s6,0x1
 93c:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x23a>
  li s7, 3235
 940:	6b85                	lui	s7,0x1
 942:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x23b>
  li s8, 3236
 946:	6c05                	lui	s8,0x1
 948:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x23c>
  li s9, 3237
 94c:	6c85                	lui	s9,0x1
 94e:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x23d>
  li s10, 3238
 952:	6d05                	lui	s10,0x1
 954:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x23e>
  li s11, 3239
 958:	6d85                	lui	s11,0x1
 95a:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x23f>
#ifdef SYS_dump
  li a7, SYS_dump
 95e:	48d9                	li	a7,22
  ecall
...
0000000000000966 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
0000000000000982 <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 988:	4ae5                	li	s5,25
  li s6, 36
 98a:	02400b13          	li	s6,36
  li s7, 49
 98e:	03100b93          	li	s7,49
  li s8, 64
 992:	04000c13          	li	s8,64
  li s9, 81
 996:	05100c93          	li	s9,81
  li s10, 100
 99a:	06400d13          	li	s10,100
  li s11, 121
 99e:	07900d93          	li	s11,121
  li a7, SYS_write
 9a2:	48c1                	li	a7,16
  ecall
 9a4:	00000073          	ecall
...
00000000000009aa <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 9aa:	53900913          	li	s2,1337
  mv a2, a1
 9ae:	862e                	mv	a2,a1
  li a1, 2
 9b0:	4589                	li	a1,2
