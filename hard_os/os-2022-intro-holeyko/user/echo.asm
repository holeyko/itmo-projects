...
int main(int argc, char *argv[]) {
  ...
  2e:	906a0a13          	addi	s4,s4,-1786 # 930 <loop+0x10>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	8d058593          	addi	a1,a1,-1840 # 938 <loop+0x18>
  70:	4505                	li	a0,1
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 4c2:	48ac8c93          	addi	s9,s9,1162 # 948 <loop+0x28>
      } else if (c == 'p') {
 ...
 4d0:	4d4b8b93          	addi	s7,s7,1236 # 9a0 <digits>
 ...
 5f6:	34e98993          	addi	s3,s3,846 # 940 <loop+0x20>
        while (*s != 0) {
 5fa:	85ee                	mv	a1,s11
...
0000000000000832 <dump_test2_asm>:
#include "kernel/syscall.h"
...
000000000000084e <dump_test3_asm>:
...
dump_test3_asm:
 ...
 850:	59d1                	li	s3,-12
  li s4, 123
 852:	07b00a13          	li	s4,123
  li s5, -1234
 856:	b2e00a93          	li	s5,-1234
  li s6, 12345
 85a:	6b0d                	lui	s6,0x3
 85c:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 860:	7b89                	lui	s7,0xfffe2
 862:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 866:	0012dc37          	lui	s8,0x12d
 86a:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 86e:	ff43acb7          	lui	s9,0xff43a
 872:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 876:	075bdd37          	lui	s10,0x75bd
 87a:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 87e:	b66a0db7          	lui	s11,0xb66a0
 882:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 886:	48d9                	li	a7,22
  ecall
...
000000000000088e <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 88e:	80000937          	lui	s2,0x80000
 892:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 894:	800009b7          	lui	s3,0x80000
  li s4, 1337
 898:	53900a13          	li	s4,1337
  li s5, 2020
 89c:	7e400a93          	li	s5,2020
  li s6, 3234
 8a0:	6b05                	lui	s6,0x1
 8a2:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x302>
  li s7, 3235
 8a6:	6b85                	lui	s7,0x1
 8a8:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x303>
  li s8, 3236
 8ac:	6c05                	lui	s8,0x1
 8ae:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x304>
  li s9, 3237
 8b2:	6c85                	lui	s9,0x1
 8b4:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x305>
  li s10, 3238
 8b8:	6d05                	lui	s10,0x1
 8ba:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x306>
  li s11, 3239
 8be:	6d85                	lui	s11,0x1
 8c0:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x307>
#ifdef SYS_dump
  li a7, SYS_dump
 8c4:	48d9                	li	a7,22
  ecall
...
00000000000008cc <dump2_test1_asm>:
#include "kernel/syscall.h"
...
00000000000008e8 <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 8ee:	4ae5                	li	s5,25
  li s6, 36
 8f0:	02400b13          	li	s6,36
  li s7, 49
 8f4:	03100b93          	li	s7,49
  li s8, 64
 8f8:	04000c13          	li	s8,64
  li s9, 81
 8fc:	05100c93          	li	s9,81
  li s10, 100
 900:	06400d13          	li	s10,100
  li s11, 121
 904:	07900d93          	li	s11,121
  li a7, SYS_write
 908:	48c1                	li	a7,16
  ecall
 90a:	00000073          	ecall
...
0000000000000910 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 910:	53900913          	li	s2,1337
  mv a2, a1
 914:	862e                	mv	a2,a1
  li a1, 2
 916:	4589                	li	a1,2
