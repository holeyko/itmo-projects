...
void wc(int fd, char *name) {
  ...
  3c:	a08a0a13          	addi	s4,s4,-1528 # a40 <loop+0xe>
        inword = 0;
  40:	4b01                	li	s6,0
  while ((n = read(fd, buf, sizeof(buf))) > 0) {
  ...
  ba:	9a250513          	addi	a0,a0,-1630 # a58 <loop+0x26>
  ...
  e8:	96450513          	addi	a0,a0,-1692 # a48 <loop+0x16>
...
int main(int argc, char *argv[]) {
 ...
 162:	90a58593          	addi	a1,a1,-1782 # a68 <loop+0x36>
 166:	4501                	li	a0,0
 ...
 180:	8f450513          	addi	a0,a0,-1804 # a70 <loop+0x3e>
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 514:	5d850513          	addi	a0,a0,1496 # ae8 <digits>
 518:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 5d4:	4c0c8c93          	addi	s9,s9,1216 # a90 <loop+0x5e>
      } else if (c == 'p') {
 ...
 5e2:	50ab8b93          	addi	s7,s7,1290 # ae8 <digits>
 ...
 708:	38498993          	addi	s3,s3,900 # a88 <loop+0x56>
        while (*s != 0) {
 70c:	85ee                	mv	a1,s11
...
0000000000000944 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000960 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 962:	59d1                	li	s3,-12
  li s4, 123
 964:	07b00a13          	li	s4,123
  li s5, -1234
 968:	b2e00a93          	li	s5,-1234
  li s6, 12345
 96c:	6b0d                	lui	s6,0x3
 96e:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x1e29>
  li s7, -123456
 972:	7b89                	lui	s7,0xfffe2
 974:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0bb0>
  li s8, 1234567
 978:	0012dc37          	lui	s8,0x12d
 97c:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c477>
  li s9, -12345678
 980:	ff43acb7          	lui	s9,0xff43a
 984:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ca2>
  li s10, 123456789
 988:	075bdd37          	lui	s10,0x75bd
 98c:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbb05>
  li s11, -1234567890
 990:	b66a0db7          	lui	s11,0xb66a0
 994:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669eb1e>
#ifdef SYS_dump
  li a7, SYS_dump
 998:	48d9                	li	a7,22
  ecall
...
00000000000009a0 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 9a0:	80000937          	lui	s2,0x80000
 9a4:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffedef>
  li s3, -2147483648
 9a6:	800009b7          	lui	s3,0x80000
  li s4, 1337
 9aa:	53900a13          	li	s4,1337
  li s5, 2020
 9ae:	7e400a93          	li	s5,2020
  li s6, 3234
 9b2:	6b05                	lui	s6,0x1
 9b4:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x1ba>
  li s7, 3235
 9b8:	6b85                	lui	s7,0x1
 9ba:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x1bb>
  li s8, 3236
 9be:	6c05                	lui	s8,0x1
 9c0:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x1bc>
  li s9, 3237
 9c4:	6c85                	lui	s9,0x1
 9c6:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x1bd>
  li s10, 3238
 9ca:	6d05                	lui	s10,0x1
 9cc:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x1be>
  li s11, 3239
 9d0:	6d85                	lui	s11,0x1
 9d2:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x1bf>
#ifdef SYS_dump
  li a7, SYS_dump
 9d6:	48d9                	li	a7,22
  ecall
...
00000000000009de <dump2_test1_asm>:
#include "kernel/syscall.h"
...
00000000000009fa <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 a00:	4ae5                	li	s5,25
  li s6, 36
 a02:	02400b13          	li	s6,36
  li s7, 49
 a06:	03100b93          	li	s7,49
  li s8, 64
 a0a:	04000c13          	li	s8,64
  li s9, 81
 a0e:	05100c93          	li	s9,81
  li s10, 100
 a12:	06400d13          	li	s10,100
  li s11, 121
 a16:	07900d93          	li	s11,121
  li a7, SYS_write
 a1a:	48c1                	li	a7,16
  ecall
 a1c:	00000073          	ecall
...
0000000000000a22 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 a22:	53900913          	li	s2,1337
  mv a2, a1
 a26:	862e                	mv	a2,a1
  li a1, 2
 a28:	4589                	li	a1,2
