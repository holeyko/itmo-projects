...
public class DatabaseUtils {
    ...
    public static Pair<PreparedStatement, Integer> executeSqlInsertQuery(SqlQueryImpl queryBuilder) throws SQLException {
        Connection connection = getDataSource().getConnection();
    ...
    public static void executeSqlUpdateQuery(SqlQueryImpl queryBuilder) throws SQLException {
        Connection connection = getDataSource().getConnection();
