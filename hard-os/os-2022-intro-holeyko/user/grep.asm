...
int main(int argc, char *argv[]) {
 ...
 252:	8f258593          	addi	a1,a1,-1806 # b40 <loop+0x6>
 256:	4509                	li	a0,2
 ...
 288:	8dc50513          	addi	a0,a0,-1828 # b60 <loop+0x26>
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 61c:	5c050513          	addi	a0,a0,1472 # bd8 <digits>
 620:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 6dc:	4a8c8c93          	addi	s9,s9,1192 # b80 <loop+0x46>
      } else if (c == 'p') {
 ...
 6ea:	4f2b8b93          	addi	s7,s7,1266 # bd8 <digits>
 ...
 810:	36c98993          	addi	s3,s3,876 # b78 <loop+0x3e>
        while (*s != 0) {
 814:	85ee                	mv	a1,s11
...
0000000000000a4c <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000a68 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 a6a:	59d1                	li	s3,-12
  li s4, 123
 a6c:	07b00a13          	li	s4,123
  li s5, -1234
 a70:	b2e00a93          	li	s5,-1234
  li s6, 12345
 a74:	6b0d                	lui	s6,0x3
 a76:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x1c29>
  li s7, -123456
 a7a:	7b89                	lui	s7,0xfffe2
 a7c:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe09b0>
  li s8, 1234567
 a80:	0012dc37          	lui	s8,0x12d
 a84:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c277>
  li s9, -12345678
 a88:	ff43acb7          	lui	s9,0xff43a
 a8c:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438aa2>
  li s10, 123456789
 a90:	075bdd37          	lui	s10,0x75bd
 a94:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bb905>
  li s11, -1234567890
 a98:	b66a0db7          	lui	s11,0xb66a0
 a9c:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669e91e>
#ifdef SYS_dump
  li a7, SYS_dump
 aa0:	48d9                	li	a7,22
  ecall
...
0000000000000aa8 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 aa8:	80000937          	lui	s2,0x80000
 aac:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffebef>
  li s3, -2147483648
 aae:	800009b7          	lui	s3,0x80000
  li s4, 1337
 ab2:	53900a13          	li	s4,1337
  li s5, 2020
 ab6:	7e400a93          	li	s5,2020
  li s6, 3234
 aba:	6b05                	lui	s6,0x1
 abc:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0xca>
  li s7, 3235
 ac0:	6b85                	lui	s7,0x1
 ac2:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0xcb>
  li s8, 3236
 ac6:	6c05                	lui	s8,0x1
 ac8:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0xcc>
  li s9, 3237
 acc:	6c85                	lui	s9,0x1
 ace:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0xcd>
  li s10, 3238
 ad2:	6d05                	lui	s10,0x1
 ad4:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0xce>
  li s11, 3239
 ad8:	6d85                	lui	s11,0x1
 ada:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0xcf>
#ifdef SYS_dump
  li a7, SYS_dump
 ade:	48d9                	li	a7,22
  ecall
...
0000000000000ae6 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
0000000000000b02 <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 b08:	4ae5                	li	s5,25
  li s6, 36
 b0a:	02400b13          	li	s6,36
  li s7, 49
 b0e:	03100b93          	li	s7,49
  li s8, 64
 b12:	04000c13          	li	s8,64
  li s9, 81
 b16:	05100c93          	li	s9,81
  li s10, 100
 b1a:	06400d13          	li	s10,100
  li s11, 121
 b1e:	07900d93          	li	s11,121
  li a7, SYS_write
 b22:	48c1                	li	a7,16
  ecall
 b24:	00000073          	ecall
...
0000000000000b2a <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 b2a:	53900913          	li	s2,1337
  mv a2, a1
 b2e:	862e                	mv	a2,a1
  li a1, 2
 b30:	4589                	li	a1,2
