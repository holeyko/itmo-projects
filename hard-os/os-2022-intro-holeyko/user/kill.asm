...
int main(int argc, char **argv) {
  ...
  4c:	8c858593          	addi	a1,a1,-1848 # 910 <loop+0x10>
  50:	4509                	li	a0,2
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3e2:	5aa50513          	addi	a0,a0,1450 # 988 <digits>
 3e6:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 4a2:	492c8c93          	addi	s9,s9,1170 # 930 <loop+0x30>
      } else if (c == 'p') {
 ...
 4b0:	4dcb8b93          	addi	s7,s7,1244 # 988 <digits>
 ...
 5d6:	35698993          	addi	s3,s3,854 # 928 <loop+0x28>
        while (*s != 0) {
 5da:	85ee                	mv	a1,s11
...
0000000000000812 <dump_test2_asm>:
#include "kernel/syscall.h"
...
000000000000082e <dump_test3_asm>:
...
dump_test3_asm:
 ...
 830:	59d1                	li	s3,-12
  li s4, 123
 832:	07b00a13          	li	s4,123
  li s5, -1234
 836:	b2e00a93          	li	s5,-1234
  li s6, 12345
 83a:	6b0d                	lui	s6,0x3
 83c:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 840:	7b89                	lui	s7,0xfffe2
 842:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 846:	0012dc37          	lui	s8,0x12d
 84a:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 84e:	ff43acb7          	lui	s9,0xff43a
 852:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 856:	075bdd37          	lui	s10,0x75bd
 85a:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 85e:	b66a0db7          	lui	s11,0xb66a0
 862:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 866:	48d9                	li	a7,22
  ecall
...
000000000000086e <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 86e:	80000937          	lui	s2,0x80000
 872:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 874:	800009b7          	lui	s3,0x80000
  li s4, 1337
 878:	53900a13          	li	s4,1337
  li s5, 2020
 87c:	7e400a93          	li	s5,2020
  li s6, 3234
 880:	6b05                	lui	s6,0x1
 882:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x31a>
  li s7, 3235
 886:	6b85                	lui	s7,0x1
 888:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x31b>
  li s8, 3236
 88c:	6c05                	lui	s8,0x1
 88e:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x31c>
  li s9, 3237
 892:	6c85                	lui	s9,0x1
 894:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x31d>
  li s10, 3238
 898:	6d05                	lui	s10,0x1
 89a:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x31e>
  li s11, 3239
 89e:	6d85                	lui	s11,0x1
 8a0:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x31f>
#ifdef SYS_dump
  li a7, SYS_dump
 8a4:	48d9                	li	a7,22
  ecall
...
00000000000008ac <dump2_test1_asm>:
#include "kernel/syscall.h"
...
00000000000008c8 <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 8ce:	4ae5                	li	s5,25
  li s6, 36
 8d0:	02400b13          	li	s6,36
  li s7, 49
 8d4:	03100b93          	li	s7,49
  li s8, 64
 8d8:	04000c13          	li	s8,64
  li s9, 81
 8dc:	05100c93          	li	s9,81
  li s10, 100
 8e0:	06400d13          	li	s10,100
  li s11, 121
 8e4:	07900d93          	li	s11,121
  li a7, SYS_write
 8e8:	48c1                	li	a7,16
  ecall
 8ea:	00000073          	ecall
...
00000000000008f0 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 8f0:	53900913          	li	s2,1337
  mv a2, a1
 8f4:	862e                	mv	a2,a1
  li a1, 2
 8f6:	4589                	li	a1,2
