...
int main(int argc, char *argv[]) {
  ...
  14:	8f058593          	addi	a1,a1,-1808 # 900 <loop+0x4>
  18:	4509                	li	a0,2
  ...
  50:	8cc58593          	addi	a1,a1,-1844 # 918 <loop+0x1c>
  54:	4509                	li	a0,2
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3de:	5b650513          	addi	a0,a0,1462 # 990 <digits>
 3e2:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 49e:	49ec8c93          	addi	s9,s9,1182 # 938 <loop+0x3c>
      } else if (c == 'p') {
 ...
 4ac:	4e8b8b93          	addi	s7,s7,1256 # 990 <digits>
 ...
 5d2:	36298993          	addi	s3,s3,866 # 930 <loop+0x34>
        while (*s != 0) {
 5d6:	85ee                	mv	a1,s11
...
000000000000080e <dump_test2_asm>:
#include "kernel/syscall.h"
...
000000000000082a <dump_test3_asm>:
...
dump_test3_asm:
 ...
 82c:	59d1                	li	s3,-12
  li s4, 123
 82e:	07b00a13          	li	s4,123
  li s5, -1234
 832:	b2e00a93          	li	s5,-1234
  li s6, 12345
 836:	6b0d                	lui	s6,0x3
 838:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 83c:	7b89                	lui	s7,0xfffe2
 83e:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 842:	0012dc37          	lui	s8,0x12d
 846:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 84a:	ff43acb7          	lui	s9,0xff43a
 84e:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 852:	075bdd37          	lui	s10,0x75bd
 856:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 85a:	b66a0db7          	lui	s11,0xb66a0
 85e:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 862:	48d9                	li	a7,22
  ecall
...
000000000000086a <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 86a:	80000937          	lui	s2,0x80000
 86e:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 870:	800009b7          	lui	s3,0x80000
  li s4, 1337
 874:	53900a13          	li	s4,1337
  li s5, 2020
 878:	7e400a93          	li	s5,2020
  li s6, 3234
 87c:	6b05                	lui	s6,0x1
 87e:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x312>
  li s7, 3235
 882:	6b85                	lui	s7,0x1
 884:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x313>
  li s8, 3236
 888:	6c05                	lui	s8,0x1
 88a:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x314>
  li s9, 3237
 88e:	6c85                	lui	s9,0x1
 890:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x315>
  li s10, 3238
 894:	6d05                	lui	s10,0x1
 896:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x316>
  li s11, 3239
 89a:	6d85                	lui	s11,0x1
 89c:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x317>
#ifdef SYS_dump
  li a7, SYS_dump
 8a0:	48d9                	li	a7,22
  ecall
...
00000000000008a8 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
00000000000008c4 <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 8ca:	4ae5                	li	s5,25
  li s6, 36
 8cc:	02400b13          	li	s6,36
  li s7, 49
 8d0:	03100b93          	li	s7,49
  li s8, 64
 8d4:	04000c13          	li	s8,64
  li s9, 81
 8d8:	05100c93          	li	s9,81
  li s10, 100
 8dc:	06400d13          	li	s10,100
  li s11, 121
 8e0:	07900d93          	li	s11,121
  li a7, SYS_write
 8e4:	48c1                	li	a7,16
  ecall
 8e6:	00000073          	ecall
...
00000000000008ec <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 8ec:	53900913          	li	s2,1337
  mv a2, a1
 8f0:	862e                	mv	a2,a1
  li a1, 2
 8f2:	4589                	li	a1,2
