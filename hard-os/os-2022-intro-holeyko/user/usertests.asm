...
void copyinstr1(char *s) {
  ...
  for (int ai = 0; ai < 2; ai++) {
    ...
    uint64 addr = addrs[ai];
      ...
      42:	1a250513          	addi	a0,a0,418 # 61e0 <loop+0xa>
...
void bsstest(char *s) {
      ...
      84:	18050513          	addi	a0,a0,384 # 6200 <loop+0x2a>
...
void opentest(char *s) {
  ...
  fd = open("echo", 0);
      ...
      ac:	17050513          	addi	a0,a0,368 # 6218 <loop+0x42>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	17250513          	addi	a0,a0,370 # 6238 <loop+0x62>
  ...
  if (fd >= 0) {
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	13a50513          	addi	a0,a0,314 # 6220 <loop+0x4a>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	14650513          	addi	a0,a0,326 # 6248 <loop+0x72>
...
void truncate2(char *s) {
  ...
  unlink("truncfile");
     ...
     130:	14450513          	addi	a0,a0,324 # 6270 <loop+0x9a>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE | O_TRUNC | O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	13050513          	addi	a0,a0,304 # 6270 <loop+0x9a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	12c58593          	addi	a1,a1,300 # 6280 <loop+0xaa>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC | O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	10850513          	addi	a0,a0,264 # 6270 <loop+0x9a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	10c58593          	addi	a1,a1,268 # 6288 <loop+0xb2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	0dc50513          	addi	a0,a0,220 # 6270 <loop+0x9a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	0c650513          	addi	a0,a0,198 # 6290 <loop+0xba>
...
void bigwrite(char *s) {
  ...
  unlink("bigwrite");
     ...
     280:	03c50513          	addi	a0,a0,60 # 62b8 <loop+0xe2>
  ...
  for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471) {
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	028a8a93          	addi	s5,s5,40 # 62b8 <loop+0xe2>
  ...
  for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471) {
     ...
     316:	fb650513          	addi	a0,a0,-74 # 62c8 <loop+0xf2>
     ...
     338:	fb450513          	addi	a0,a0,-76 # 62e8 <loop+0x112>
...
void badwrite(char *s) {
  ...
  unlink("junk");
     ...
     362:	fa250513          	addi	a0,a0,-94 # 6300 <loop+0x12a>
  ...
  for (int i = 0; i < assumed_free; i++) {
    int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     376:	f8e98993          	addi	s3,s3,-114 # 6300 <loop+0x12a>
    if (fd < 0) {
  ...
  int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     3c2:	f4250513          	addi	a0,a0,-190 # 6300 <loop+0x12a>
  ...
  if (write(fd, "x", 1) != 1) {
     ...
     3da:	eb258593          	addi	a1,a1,-334 # 6288 <loop+0xb2>
    ...
    printf("write failed\n");
     ...
     3f0:	f3450513          	addi	a0,a0,-204 # 6320 <loop+0x14a>
    ...
    exit(1);
     ...
     40a:	f0250513          	addi	a0,a0,-254 # 6308 <loop+0x132>
    ...
    printf("open junk failed\n");
     ...
     424:	ee850513          	addi	a0,a0,-280 # 6308 <loop+0x132>
  ...
  unlink("junk");
     ...
     448:	ebc50513          	addi	a0,a0,-324 # 6300 <loop+0x12a>
...
void copyin(char *s) {
  ...
  for (int ai = 0; ai < 2; ai++) {
    ...
    int fd = open("copyin1", O_CREATE | O_WRONLY);
     ...
     554:	de0a0a13          	addi	s4,s4,-544 # 6330 <loop+0x15a>
    uint64 addr = addrs[ai];
  ...
  for (int ai = 0; ai < 2; ai++) {
     ...
     600:	d3c50513          	addi	a0,a0,-708 # 6338 <loop+0x162>
     ...
     61e:	d3650513          	addi	a0,a0,-714 # 6350 <loop+0x17a>
     ...
     63c:	d4850513          	addi	a0,a0,-696 # 6380 <loop+0x1aa>
     ...
     656:	d5e50513          	addi	a0,a0,-674 # 63b0 <loop+0x1da>
     ...
     674:	d5050513          	addi	a0,a0,-688 # 63c0 <loop+0x1ea>
...
void copyout(char *s) {
  ...
  for (int ai = 0; ai < 2; ai++) {
    ...
    int fd = open("README", 0);
     ...
     6b2:	d42a0a13          	addi	s4,s4,-702 # 63f0 <loop+0x21a>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	bd2a8a93          	addi	s5,s5,-1070 # 6288 <loop+0xb2>
    uint64 addr = addrs[ai];
  ...
  for (int ai = 0; ai < 2; ai++) {
     ...
     760:	c9c50513          	addi	a0,a0,-868 # 63f8 <loop+0x222>
     ...
     77e:	c9650513          	addi	a0,a0,-874 # 6410 <loop+0x23a>
     ...
     798:	c1c50513          	addi	a0,a0,-996 # 63b0 <loop+0x1da>
     ...
     7b2:	c9250513          	addi	a0,a0,-878 # 6440 <loop+0x26a>
     ...
     7d0:	c8c50513          	addi	a0,a0,-884 # 6458 <loop+0x282>
...
void truncate1(char *s) {
  ...
  write(fd1, "abcd", 4);
     ...
     826:	a5e58593          	addi	a1,a1,-1442 # 6280 <loop+0xaa>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	a3250513          	addi	a0,a0,-1486 # 6270 <loop+0x9a>
  ...
  fd1 = open("truncfile", O_WRONLY | O_TRUNC);
     ...
     86e:	a0650513          	addi	a0,a0,-1530 # 6270 <loop+0x9a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	9f250513          	addi	a0,a0,-1550 # 6270 <loop+0x9a>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	c2c58593          	addi	a1,a1,-980 # 64e8 <loop+0x312>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	97250513          	addi	a0,a0,-1678 # 6270 <loop+0x9a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	b4650513          	addi	a0,a0,-1210 # 6488 <loop+0x2b2>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	b4a50513          	addi	a0,a0,-1206 # 64a8 <loop+0x2d2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	b4650513          	addi	a0,a0,-1210 # 64b8 <loop+0x2e2>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	b4a50513          	addi	a0,a0,-1206 # 64d8 <loop+0x302>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	b1650513          	addi	a0,a0,-1258 # 64b8 <loop+0x2e2>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	b3050513          	addi	a0,a0,-1232 # 64f0 <loop+0x31a>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	b3250513          	addi	a0,a0,-1230 # 6510 <loop+0x33a>
...
void writetest(char *s) {
  ...
  fd = open("small", O_CREATE | O_RDWR);
     ...
     a16:	b1e50513          	addi	a0,a0,-1250 # 6530 <loop+0x35a>
  ...
  if (fd < 0) {
    ...
    if (write(fd, "aaaaaaaaaa", SZ) != SZ) {
     ...
     a2e:	b2e98993          	addi	s3,s3,-1234 # 6558 <loop+0x382>
    if (write(fd, "bbbbbbbbbb", SZ) != SZ) {
     a32:	00006a97          	auipc	s5,0x6
     a36:	b5ea8a93          	addi	s5,s5,-1186 # 6590 <loop+0x3ba>
  for (i = 0; i < N; i++) {
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	ab850513          	addi	a0,a0,-1352 # 6530 <loop+0x35a>
  ...
  if (unlink("small") < 0) {
     ...
     ab8:	a7c50513          	addi	a0,a0,-1412 # 6530 <loop+0x35a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	a5a50513          	addi	a0,a0,-1446 # 6538 <loop+0x362>
    ...
    exit(1);
     ...
     b00:	a6c50513          	addi	a0,a0,-1428 # 6568 <loop+0x392>
     ...
     b1e:	a8650513          	addi	a0,a0,-1402 # 65a0 <loop+0x3ca>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a9250513          	addi	a0,a0,-1390 # 65c8 <loop+0x3f2>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a9650513          	addi	a0,a0,-1386 # 65e8 <loop+0x412>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a9250513          	addi	a0,a0,-1390 # 6600 <loop+0x42a>
...
void writebig(char *s) {
  ...
  fd = open("big", O_CREATE | O_RDWR);
     ...
     ba4:	a8050513          	addi	a0,a0,-1408 # 6620 <loop+0x44a>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	a2e50513          	addi	a0,a0,-1490 # 6620 <loop+0x44a>
  ...
  if (fd < 0) {
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	9ee50513          	addi	a0,a0,-1554 # 6628 <loop+0x452>
    ...
    exit(1);
     ...
     c5c:	9f050513          	addi	a0,a0,-1552 # 6648 <loop+0x472>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	9fc50513          	addi	a0,a0,-1540 # 6670 <loop+0x49a>
  ...
  if (unlink("big") < 0) {
     ...
     ca4:	98050513          	addi	a0,a0,-1664 # 6620 <loop+0x44a>
     ...
     cd0:	9c450513          	addi	a0,a0,-1596 # 6690 <loop+0x4ba>
     ...
     cee:	9ce50513          	addi	a0,a0,-1586 # 66b8 <loop+0x4e2>
     ...
     d0c:	9c850513          	addi	a0,a0,-1592 # 66d0 <loop+0x4fa>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	9d450513          	addi	a0,a0,-1580 # 66f8 <loop+0x522>
...
void unlinkread(char *s) {
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	9be50513          	addi	a0,a0,-1602 # 6710 <loop+0x53a>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	9d658593          	addi	a1,a1,-1578 # 6740 <loop+0x56a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	98a50513          	addi	a0,a0,-1654 # 6710 <loop+0x53a>
  ...
  if (unlink("unlinkread") != 0) {
     ...
     da0:	97450513          	addi	a0,a0,-1676 # 6710 <loop+0x53a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	95e50513          	addi	a0,a0,-1698 # 6710 <loop+0x53a>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	9c258593          	addi	a1,a1,-1598 # 6788 <loop+0x5b2>
  ...
  unlink("unlinkread");
     ...
     e32:	8e250513          	addi	a0,a0,-1822 # 6710 <loop+0x53a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	8d250513          	addi	a0,a0,-1838 # 6720 <loop+0x54a>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	8de50513          	addi	a0,a0,-1826 # 6748 <loop+0x572>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	8e250513          	addi	a0,a0,-1822 # 6768 <loop+0x592>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	8ee50513          	addi	a0,a0,-1810 # 6790 <loop+0x5ba>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	8f250513          	addi	a0,a0,-1806 # 67b0 <loop+0x5da>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	8f650513          	addi	a0,a0,-1802 # 67d0 <loop+0x5fa>
...
void linktest(char *s) {
  ...
  if (write(fd, "hello", SZ) != SZ) {
     ...
     f42:	80258593          	addi	a1,a1,-2046 # 6740 <loop+0x56a>
  ...
  if (link("lf1", "lf2") < 0) {
     ...
     f62:	89a58593          	addi	a1,a1,-1894 # 67f8 <loop+0x622>
     f66:	00006517          	auipc	a0,0x6
     f6a:	88a50513          	addi	a0,a0,-1910 # 67f0 <loop+0x61a>
  ...
  unlink("lf1");
     ...
     f7e:	87650513          	addi	a0,a0,-1930 # 67f0 <loop+0x61a>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if (open("lf1", 0) >= 0) {
     f8a:	4581                	li	a1,0
     f8c:	00006517          	auipc	a0,0x6
     f90:	86450513          	addi	a0,a0,-1948 # 67f0 <loop+0x61a>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	85650513          	addi	a0,a0,-1962 # 67f8 <loop+0x622>
  ...
  if (link("lf2", "lf2") >= 0) {
     ...
     fde:	81e58593          	addi	a1,a1,-2018 # 67f8 <loop+0x622>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	80850513          	addi	a0,a0,-2040 # 67f8 <loop+0x622>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if (link("lf2", "lf1") >= 0) {
    1000:	00005597          	auipc	a1,0x5
    1004:	7f058593          	addi	a1,a1,2032 # 67f0 <loop+0x61a>
    1008:	00005517          	auipc	a0,0x5
    100c:	7f050513          	addi	a0,a0,2032 # 67f8 <loop+0x622>
  ...
  if (link(".", "lf1") >= 0) {
    ...
    1020:	7d458593          	addi	a1,a1,2004 # 67f0 <loop+0x61a>
    1024:	00006517          	auipc	a0,0x6
    1028:	8dc50513          	addi	a0,a0,-1828 # 6900 <loop+0x72a>
    ...
    104a:	7ba50513          	addi	a0,a0,1978 # 6800 <loop+0x62a>
    ...
    1066:	7b650513          	addi	a0,a0,1974 # 6818 <loop+0x642>
    ...
    1082:	7b250513          	addi	a0,a0,1970 # 6830 <loop+0x65a>
    ...
    109e:	7b650513          	addi	a0,a0,1974 # 6850 <loop+0x67a>
    ...
    10ba:	7ca50513          	addi	a0,a0,1994 # 6880 <loop+0x6aa>
    ...
    10d6:	7c650513          	addi	a0,a0,1990 # 6898 <loop+0x6c2>
    ...
    10f2:	7c250513          	addi	a0,a0,1986 # 68b0 <loop+0x6da>
    ...
    110e:	7ce50513          	addi	a0,a0,1998 # 68d8 <loop+0x702>
    ...
    112a:	7e250513          	addi	a0,a0,2018 # 6908 <loop+0x732>
...
void validatetest(char *s) {
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
    ...
    115c:	7d098993          	addi	s3,s3,2000 # 6928 <loop+0x752>
    1160:	597d                	li	s2,-1
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
    ...
    1198:	7a450513          	addi	a0,a0,1956 # 6938 <loop+0x762>
...
void bigdir(char *s) {
  ...
  for (i = 0; i < N; i++) {
    ...
    11fe:	75ea0a13          	addi	s4,s4,1886 # 6958 <loop+0x782>
  for (i = 0; i < N; i++) {
  ...
  unlink("bd");
    ...
    1250:	70c50513          	addi	a0,a0,1804 # 6958 <loop+0x782>
  ...
  for (i = 0; i < N; i++) {
    ...
    12c0:	6a450513          	addi	a0,a0,1700 # 6960 <loop+0x78a>
    ...
    12e0:	6a450513          	addi	a0,a0,1700 # 6980 <loop+0x7aa>
    ...
    12fc:	6a850513          	addi	a0,a0,1704 # 69a0 <loop+0x7ca>
...
void badarg(char *s) {
    ...
    1368:	eb498993          	addi	s3,s3,-332 # 6218 <loop+0x42>
    argv[0] = (char *)0xffffffff;
...
void copyinstr2(char *s) {
  ...
  char *args[] = {"xx", 0};
    ...
    13f2:	80a78793          	addi	a5,a5,-2038 # 7bf8 <loop+0x1a22>
  ...
  if (pid == 0) {
    ...
    144e:	1ee78793          	addi	a5,a5,494 # 8638 <loop+0x2462>
    ...
    1472:	daa50513          	addi	a0,a0,-598 # 6218 <loop+0x42>
    ...
    148a:	5c250513          	addi	a0,a0,1474 # 6a48 <loop+0x872>
    ...
    14aa:	51a50513          	addi	a0,a0,1306 # 69c0 <loop+0x7ea>
    ...
    14ca:	51a50513          	addi	a0,a0,1306 # 69e0 <loop+0x80a>
    ...
    14ec:	51850513          	addi	a0,a0,1304 # 6a00 <loop+0x82a>
    ...
    150c:	52050513          	addi	a0,a0,1312 # 6a28 <loop+0x852>
    ...
    1526:	98650513          	addi	a0,a0,-1658 # 6ea8 <loop+0xcd2>
  ...
  if (st != 747) {
    ...
    1570:	50450513          	addi	a0,a0,1284 # 6a70 <loop+0x89a>
...
void truncate3(char *s) {
  ...
  close(open("truncfile", O_CREATE | O_TRUNC | O_WRONLY));
    ...
    15a2:	cd250513          	addi	a0,a0,-814 # 6270 <loop+0x9a>
  ...
  if (pid == 0) {
    ...
    15cc:	ca8a0a13          	addi	s4,s4,-856 # 6270 <loop+0x9a>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	500a8a93          	addi	s5,s5,1280 # 6ad0 <loop+0x8fa>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	46050513          	addi	a0,a0,1120 # 6aa0 <loop+0x8ca>
    ...
    1660:	45c50513          	addi	a0,a0,1116 # 6ab8 <loop+0x8e2>
    ...
    167e:	46650513          	addi	a0,a0,1126 # 6ae0 <loop+0x90a>
    ...
    169c:	bd8a0a13          	addi	s4,s4,-1064 # 6270 <loop+0x9a>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	460a8a93          	addi	s5,s5,1120 # 6b00 <loop+0x92a>
    int fd = open("truncfile", O_CREATE | O_WRONLY | O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	b8650513          	addi	a0,a0,-1146 # 6270 <loop+0x9a>
  ...
  exit(xstatus);
    ...
    170c:	3b050513          	addi	a0,a0,944 # 6ab8 <loop+0x8e2>
    ...
    172a:	3e250513          	addi	a0,a0,994 # 6b08 <loop+0x932>
...
void exectest(char *s) {
  ...
  char *echoargv[] = {"echo", "OK", 0};
    ...
    1752:	aca78793          	addi	a5,a5,-1334 # 6218 <loop+0x42>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	3ce78793          	addi	a5,a5,974 # 6b28 <loop+0x952>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	3c650513          	addi	a0,a0,966 # 6b30 <loop+0x95a>
  ...
  if (pid == 0) {
    ...
    179c:	39850513          	addi	a0,a0,920 # 6b30 <loop+0x95a>
    ...
    17b8:	39c50513          	addi	a0,a0,924 # 6b50 <loop+0x97a>
    ...
    17d4:	2d050513          	addi	a0,a0,720 # 6aa0 <loop+0x8ca>
    ...
    17f0:	34c50513          	addi	a0,a0,844 # 6b38 <loop+0x962>
    ...
    180e:	a0e50513          	addi	a0,a0,-1522 # 6218 <loop+0x42>
  ...
  if (xstatus != 0) exit(xstatus);
    ...
    1842:	32250513          	addi	a0,a0,802 # 6b60 <loop+0x98a>
    ...
    185e:	31e50513          	addi	a0,a0,798 # 6b78 <loop+0x9a2>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	2c250513          	addi	a0,a0,706 # 6b30 <loop+0x95a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	d5050513          	addi	a0,a0,-688 # 65e8 <loop+0x412>
    ...
    18b8:	20450513          	addi	a0,a0,516 # 6ab8 <loop+0x8e2>
  ...
  unlink("echo-ok");
    ...
    18d2:	26250513          	addi	a0,a0,610 # 6b30 <loop+0x95a>
  ...
  if (buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	29850513          	addi	a0,a0,664 # 6b90 <loop+0x9ba>
...
void pipe1(char *s) {
  ...
  if (pid == 0) {
    ...
    19bc:	1f050513          	addi	a0,a0,496 # 6ba8 <loop+0x9d2>
...
void pipe1(char *s) {
    ...
    1a42:	18250513          	addi	a0,a0,386 # 6bc0 <loop+0x9ea>
    ...
    1a5e:	17e50513          	addi	a0,a0,382 # 6bd8 <loop+0xa02>
    ...
    1a90:	16450513          	addi	a0,a0,356 # 6bf0 <loop+0xa1a>
    ...
    1ad0:	14450513          	addi	a0,a0,324 # 6c10 <loop+0xa3a>
...
void exitwait(char *s) {
  ...
  for (i = 0; i < 100; i++) {
    ...
    1b42:	f6250513          	addi	a0,a0,-158 # 6aa0 <loop+0x8ca>
    ...
    1b5e:	0ce50513          	addi	a0,a0,206 # 6c28 <loop+0xa52>
    ...
    1b7a:	0ca50513          	addi	a0,a0,202 # 6c40 <loop+0xa6a>
...
void twochildren(char *s) {
  ...
  for (int i = 0; i < 1000; i++) {
    ...
    1bf2:	eb250513          	addi	a0,a0,-334 # 6aa0 <loop+0x8ca>
    ...
    1c16:	e8e50513          	addi	a0,a0,-370 # 6aa0 <loop+0x8ca>
...
void forkfork(char *s) {
    ...
    1c90:	fd450513          	addi	a0,a0,-44 # 6c60 <loop+0xa8a>
...
void forkfork(char *s) {
    ...
    1ce8:	f8c50513          	addi	a0,a0,-116 # 6c70 <loop+0xa9a>
...
void reparent2(char *s) {
  ...
  exit(0);
    ...
    1d36:	17650513          	addi	a0,a0,374 # 6ea8 <loop+0xcd2>
...
void createdelete(char *s) {
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	0d850513          	addi	a0,a0,216 # 6ea8 <loop+0xcd2>
    ...
    1e00:	d3c50513          	addi	a0,a0,-708 # 6b38 <loop+0x962>
    ...
    1e72:	e2250513          	addi	a0,a0,-478 # 6c90 <loop+0xaba>
    ...
    1ea6:	e0650513          	addi	a0,a0,-506 # 6ca8 <loop+0xad2>
    ...
    1f0c:	dc850513          	addi	a0,a0,-568 # 6cd0 <loop+0xafa>
...
void linkunlink(char *s) {
  ...
  unlink("x");
    ...
    1fac:	2e050513          	addi	a0,a0,736 # 6288 <loop+0xb2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	2a4a8a93          	addi	s5,s5,676 # 6288 <loop+0xb2>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	d0cb8b93          	addi	s7,s7,-756 # 6cf8 <loop+0xb22>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	aa850513          	addi	a0,a0,-1368 # 6aa0 <loop+0x8ca>
...
void forktest(char *s) {
  ...
  for (n = 0; n < N; n++) {
    ...
    20be:	c5e50513          	addi	a0,a0,-930 # 6d18 <loop+0xb42>
  ...
  if (wait(0) != -1) {
    ...
    2120:	be450513          	addi	a0,a0,-1052 # 6d00 <loop+0xb2a>
    ...
    213c:	c0850513          	addi	a0,a0,-1016 # 6d40 <loop+0xb6a>
    ...
    2158:	c0450513          	addi	a0,a0,-1020 # 6d58 <loop+0xb82>
...
void kernmem(char *s) {
  ...
  for (a = (char *)(KERNBASE); a < (char *)(KERNBASE + 2000000); a += 50000) {
    ...
    21d8:	8cc50513          	addi	a0,a0,-1844 # 6aa0 <loop+0x8ca>
    ...
    21fa:	b7a50513          	addi	a0,a0,-1158 # 6d70 <loop+0xb9a>
...
void MAXVAplus(char *s) {
  ...
  for (; a != 0; a <<= 1) {
    ...
    227c:	82850513          	addi	a0,a0,-2008 # 6aa0 <loop+0x8ca>
    ...
    22a8:	aec50513          	addi	a0,a0,-1300 # 6d90 <loop+0xbba>
...
void bigargtest(char *s) {
  ...
  unlink("bigarg-ok");
    ...
    22d8:	ad450513          	addi	a0,a0,-1324 # 6da8 <loop+0xbd2>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	aa250513          	addi	a0,a0,-1374 # 6da8 <loop+0xbd2>
  ...
  close(fd);
    ...
    2340:	a7c70713          	addi	a4,a4,-1412 # 6db8 <loop+0xbe2>
    ...
    2394:	b0850513          	addi	a0,a0,-1272 # 6e98 <loop+0xcc2>
  ...
  if (xstatus != 0) exit(xstatus);
    ...
    23b8:	b0450513          	addi	a0,a0,-1276 # 6eb8 <loop+0xce2>
...
static inline uint64 r_sp() {
  ...
  asm volatile("mv %0, sp" : "=r"(x));
    ...
    2416:	ac650513          	addi	a0,a0,-1338 # 6ed8 <loop+0xd02>
    ...
    2432:	67250513          	addi	a0,a0,1650 # 6aa0 <loop+0x8ca>
...
void textwrite(char *s) {
  ...
  if (xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	60450513          	addi	a0,a0,1540 # 6aa0 <loop+0x8ca>
...
void manywrites(char *s) {
  ...
  exit(0);
    ...
    251c:	99050513          	addi	a0,a0,-1648 # 6ea8 <loop+0xcd2>
    ...
    25cc:	93850513          	addi	a0,a0,-1736 # 6f00 <loop+0xd2a>
    ...
    25ec:	d0050513          	addi	a0,a0,-768 # 62e8 <loop+0x112>
...
void copyinstr3(char *s) {
  ...
  *b = 'x';
  ...
  char *args[] = {"xx", 0};
    ...
    2684:	57878793          	addi	a5,a5,1400 # 7bf8 <loop+0x1a22>
  ...
  if (ret != -1) {
    ...
    26c6:	85650513          	addi	a0,a0,-1962 # 6f18 <loop+0xd42>
    ...
    26e4:	2e050513          	addi	a0,a0,736 # 69c0 <loop+0x7ea>
    ...
    2702:	2e250513          	addi	a0,a0,738 # 69e0 <loop+0x80a>
    ...
    2722:	2e250513          	addi	a0,a0,738 # 6a00 <loop+0x82a>
    ...
    2740:	2ec50513          	addi	a0,a0,748 # 6a28 <loop+0x852>
...
void rwsbrk() {
  ...
  fd = open("rwsbrk", O_CREATE | O_WRONLY);
    ...
    278c:	7d050513          	addi	a0,a0,2000 # 6f58 <loop+0xd82>
  ...
  if (n >= 0) {
    ...
    27bc:	7c050513          	addi	a0,a0,1984 # 6f78 <loop+0xda2>
    ...
    27d6:	74e50513          	addi	a0,a0,1870 # 6f20 <loop+0xd4a>
    ...
    27f0:	74c50513          	addi	a0,a0,1868 # 6f38 <loop+0xd62>
    ...
    280a:	75a50513          	addi	a0,a0,1882 # 6f60 <loop+0xd8a>
  ...
  if (n >= 0) {
    ...
    286a:	74250513          	addi	a0,a0,1858 # 6fa8 <loop+0xdd2>
    ...
    2884:	6e050513          	addi	a0,a0,1760 # 6f60 <loop+0xd8a>
...
void sbrkbasic(char *s) {
  ...
  if (pid == 0) {
    ...
    2904:	6d050513          	addi	a0,a0,1744 # 6fd0 <loop+0xdfa>
  ...
  for (i = 0; i < 5000; i++) {
    ...
    2956:	69e50513          	addi	a0,a0,1694 # 6ff0 <loop+0xe1a>
  ...
  if (c != a + 1) {
    ...
    29ba:	69a50513          	addi	a0,a0,1690 # 7050 <loop+0xe7a>
    ...
    29dc:	63850513          	addi	a0,a0,1592 # 7010 <loop+0xe3a>
    ...
    29f8:	63c50513          	addi	a0,a0,1596 # 7030 <loop+0xe5a>
...
void sbrkmuch(char *s) {
  ...
  *lastaddr = 99;
  ...
  if (c != a) {
    ...
    2b42:	53250513          	addi	a0,a0,1330 # 7070 <loop+0xe9a>
    ...
    2b5e:	55e50513          	addi	a0,a0,1374 # 70b8 <loop+0xee2>
    ...
    2b7e:	55e50513          	addi	a0,a0,1374 # 70d8 <loop+0xf02>
    ...
    2b9e:	57e50513          	addi	a0,a0,1406 # 7118 <loop+0xf42>
    ...
    2bba:	59250513          	addi	a0,a0,1426 # 7148 <loop+0xf72>
    ...
    2bda:	5aa50513          	addi	a0,a0,1450 # 7180 <loop+0xfaa>
...
void sbrkarg(char *s) {
  ...
  fd = open("sbrk", O_CREATE | O_WRONLY);
    ...
    2c14:	59850513          	addi	a0,a0,1432 # 71a8 <loop+0xfd2>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	58650513          	addi	a0,a0,1414 # 71a8 <loop+0xfd2>
  ...
  if (pipe((int *)a) != 0) {
    ...
    2c7a:	53a50513          	addi	a0,a0,1338 # 71b0 <loop+0xfda>
    ...
    2c96:	53650513          	addi	a0,a0,1334 # 71c8 <loop+0xff2>
    ...
    2cb2:	efa50513          	addi	a0,a0,-262 # 6ba8 <loop+0x9d2>
...
void argptest(char *s) {
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	50850513          	addi	a0,a0,1288 # 71e0 <loop+0x100a>
  ...
  close(fd);
    ...
    2d24:	d9850513          	addi	a0,a0,-616 # 6ab8 <loop+0x8e2>
...
void sbrkbugs(char *s) {
  ...
  if (pid == 0) {
    ...
    2d72:	13a50513          	addi	a0,a0,314 # 6ea8 <loop+0xcd2>
  ...
  if (pid == 0) {
    ...
    2dc8:	0e450513          	addi	a0,a0,228 # 6ea8 <loop+0xcd2>
  ...
  if (pid == 0) {
    ...
    2e28:	08450513          	addi	a0,a0,132 # 6ea8 <loop+0xcd2>
...
void execout(char *s) {
  ...
  exit(0);
    ...
    2f9c:	f1050513          	addi	a0,a0,-240 # 6ea8 <loop+0xcd2>
    ...
    2ff0:	22c50513          	addi	a0,a0,556 # 6218 <loop+0x42>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	29078793          	addi	a5,a5,656 # 6288 <loop+0xb2>
...
void fourteen(char *s) {
  ...
  if (mkdir("12345678901234") != 0) {
    ...
    302e:	38e50513          	addi	a0,a0,910 # 73b8 <loop+0x11e2>
  ...
  if (mkdir("12345678901234/123456789012345") != 0) {
    ...
    3040:	1d450513          	addi	a0,a0,468 # 7210 <loop+0x103a>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	21650513          	addi	a0,a0,534 # 7268 <loop+0x1092>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	27050513          	addi	a0,a0,624 # 72e0 <loop+0x110a>
  ...
  if (mkdir("12345678901234/12345678901234") == 0) {
    ...
    3090:	2c450513          	addi	a0,a0,708 # 7350 <loop+0x117a>
  ...
  if (mkdir("123456789012345/12345678901234") == 0) {
    ...
    30a2:	30a50513          	addi	a0,a0,778 # 73a8 <loop+0x11d2>
  ...
  unlink("12345678901234");
    ...
    3120:	0cc50513          	addi	a0,a0,204 # 71e8 <loop+0x1012>
    ...
    313c:	0f850513          	addi	a0,a0,248 # 7230 <loop+0x105a>
    ...
    3158:	14450513          	addi	a0,a0,324 # 7298 <loop+0x10c2>
    ...
    3174:	1a050513          	addi	a0,a0,416 # 7310 <loop+0x113a>
    ...
    3190:	1e450513          	addi	a0,a0,484 # 7370 <loop+0x119a>
    ...
    31ac:	22050513          	addi	a0,a0,544 # 73c8 <loop+0x11f2>
...
void diskfull(char *s) {
  ...
  unlink("diskfulldir");
    ...
    31f8:	20c50513          	addi	a0,a0,524 # 7400 <loop+0x122a>
  ...
  for (fi = 0; done == 0; fi++) {
    ...
    3222:	1f250513          	addi	a0,a0,498 # 7410 <loop+0x123a>
  ...
  if (mkdir("diskfulldir") == 0)
    ...
    32b2:	15250513          	addi	a0,a0,338 # 7400 <loop+0x122a>
  ...
  unlink("diskfulldir");
    ...
    32c6:	13e50513          	addi	a0,a0,318 # 7400 <loop+0x122a>
  ...
  for (fi = 0; done == 0; fi++) {
    ...
    33f4:	04050513          	addi	a0,a0,64 # 7430 <loop+0x125a>
...
void iputtest(char *s) {
  ...
  if (mkdir("iputdir") < 0) {
    ...
    3412:	05250513          	addi	a0,a0,82 # 7460 <loop+0x128a>
  ...
  if (chdir("iputdir") < 0) {
    ...
    3426:	03e50513          	addi	a0,a0,62 # 7460 <loop+0x128a>
  ...
  if (unlink("../iputdir") < 0) {
    ...
    343a:	06a50513          	addi	a0,a0,106 # 74a0 <loop+0x12ca>
  ...
  if (chdir("/") < 0) {
    ...
    344e:	08650513          	addi	a0,a0,134 # 74d0 <loop+0x12fa>
    ...
    346e:	ffe50513          	addi	a0,a0,-2 # 7468 <loop+0x1292>
    ...
    348a:	ffa50513          	addi	a0,a0,-6 # 7480 <loop+0x12aa>
    ...
    34a6:	00e50513          	addi	a0,a0,14 # 74b0 <loop+0x12da>
    ...
    34c2:	01a50513          	addi	a0,a0,26 # 74d8 <loop+0x1302>
...
void exitiputtest(char *s) {
  ...
  if (pid == 0) {
    ...
    34f6:	f6e50513          	addi	a0,a0,-146 # 7460 <loop+0x128a>
    ...
    350a:	f5a50513          	addi	a0,a0,-166 # 7460 <loop+0x128a>
    ...
    351e:	f8650513          	addi	a0,a0,-122 # 74a0 <loop+0x12ca>
    ...
    353e:	56650513          	addi	a0,a0,1382 # 6aa0 <loop+0x8ca>
    ...
    355a:	f1250513          	addi	a0,a0,-238 # 7468 <loop+0x1292>
    ...
    3576:	f7e50513          	addi	a0,a0,-130 # 74f0 <loop+0x131a>
    ...
    3592:	f2250513          	addi	a0,a0,-222 # 74b0 <loop+0x12da>
...
void dirtest(char *s) {
  ...
  if (mkdir("dir0") < 0) {
    ...
    35d0:	f3c50513          	addi	a0,a0,-196 # 7508 <loop+0x1332>
  ...
  if (chdir("dir0") < 0) {
    ...
    35e4:	f2850513          	addi	a0,a0,-216 # 7508 <loop+0x1332>
  ...
  if (chdir("..") < 0) {
    ...
    35f8:	f3450513          	addi	a0,a0,-204 # 7528 <loop+0x1352>
  ...
  if (unlink("dir0") < 0) {
    ...
    360c:	f0050513          	addi	a0,a0,-256 # 7508 <loop+0x1332>
    ...
    362c:	e4050513          	addi	a0,a0,-448 # 7468 <loop+0x1292>
    ...
    3648:	ecc50513          	addi	a0,a0,-308 # 7510 <loop+0x133a>
    ...
    3664:	ed050513          	addi	a0,a0,-304 # 7530 <loop+0x135a>
    ...
    3680:	ecc50513          	addi	a0,a0,-308 # 7548 <loop+0x1372>
...
void subdir(char *s) {
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	eb450513          	addi	a0,a0,-332 # 7580 <loop+0x13aa>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	fac58593          	addi	a1,a1,-84 # 7690 <loop+0x14ba>
  ...
  if (unlink("dd") >= 0) {
    ...
    3702:	e6250513          	addi	a0,a0,-414 # 7560 <loop+0x138a>
  ...
  if (mkdir("/dd/dd") != 0) {
    ...
    3716:	ec650513          	addi	a0,a0,-314 # 75d8 <loop+0x1402>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	ed650513          	addi	a0,a0,-298 # 7600 <loop+0x142a>
  ...
  write(fd, "FF", 2);
    ...
    3746:	eee58593          	addi	a1,a1,-274 # 7630 <loop+0x145a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	eda50513          	addi	a0,a0,-294 # 7638 <loop+0x1462>
  ...
  if (link("dd/dd/ff", "dd/dd/ffff") != 0) {
    ...
    37aa:	ee258593          	addi	a1,a1,-286 # 7688 <loop+0x14b2>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	e5250513          	addi	a0,a0,-430 # 7600 <loop+0x142a>
  ...
  if (unlink("dd/dd/ff") != 0) {
    ...
    37c6:	e3e50513          	addi	a0,a0,-450 # 7600 <loop+0x142a>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0) {
    ...
    37dc:	e2850513          	addi	a0,a0,-472 # 7600 <loop+0x142a>
  ...
  if (chdir("dd") != 0) {
    ...
    37f0:	d7450513          	addi	a0,a0,-652 # 7560 <loop+0x138a>
  ...
  if (chdir("dd/../../dd") != 0) {
    ...
    3804:	f2050513          	addi	a0,a0,-224 # 7720 <loop+0x154a>
  ...
  if (chdir("dd/../../../dd") != 0) {
    ...
    3818:	f3c50513          	addi	a0,a0,-196 # 7750 <loop+0x157a>
  ...
  if (chdir("./..") != 0) {
    ...
    382c:	f5850513          	addi	a0,a0,-168 # 7780 <loop+0x15aa>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	e4a50513          	addi	a0,a0,-438 # 7688 <loop+0x14b2>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0) {
    ...
    387c:	d8850513          	addi	a0,a0,-632 # 7600 <loop+0x142a>
  ...
  if (open("dd/ff/ff", O_CREATE | O_RDWR) >= 0) {
    ...
    3894:	f8050513          	addi	a0,a0,-128 # 7810 <loop+0x163a>
  ...
  if (open("dd/xx/ff", O_CREATE | O_RDWR) >= 0) {
    ...
    38ac:	f9850513          	addi	a0,a0,-104 # 7840 <loop+0x166a>
  ...
  if (open("dd", O_CREATE) >= 0) {
    ...
    38c4:	ca050513          	addi	a0,a0,-864 # 7560 <loop+0x138a>
  ...
  if (open("dd", O_RDWR) >= 0) {
    ...
    38da:	c8a50513          	addi	a0,a0,-886 # 7560 <loop+0x138a>
  ...
  if (open("dd", O_WRONLY) >= 0) {
    ...
    38f0:	c7450513          	addi	a0,a0,-908 # 7560 <loop+0x138a>
  ...
  if (link("dd/ff/ff", "dd/dd/xx") == 0) {
    ...
    3904:	fd058593          	addi	a1,a1,-48 # 78d0 <loop+0x16fa>
    3908:	00004517          	auipc	a0,0x4
    390c:	f0850513          	addi	a0,a0,-248 # 7810 <loop+0x163a>
  ...
  if (link("dd/xx/ff", "dd/dd/xx") == 0) {
    ...
    3920:	fb458593          	addi	a1,a1,-76 # 78d0 <loop+0x16fa>
    3924:	00004517          	auipc	a0,0x4
    3928:	f1c50513          	addi	a0,a0,-228 # 7840 <loop+0x166a>
  ...
  if (link("dd/ff", "dd/dd/ffff") == 0) {
    ...
    393c:	d5058593          	addi	a1,a1,-688 # 7688 <loop+0x14b2>
    3940:	00004517          	auipc	a0,0x4
    3944:	c4050513          	addi	a0,a0,-960 # 7580 <loop+0x13aa>
  ...
  if (mkdir("dd/ff/ff") == 0) {
    ...
    3958:	ebc50513          	addi	a0,a0,-324 # 7810 <loop+0x163a>
  ...
  if (mkdir("dd/xx/ff") == 0) {
    ...
    396c:	ed850513          	addi	a0,a0,-296 # 7840 <loop+0x166a>
  ...
  if (mkdir("dd/dd/ffff") == 0) {
    ...
    3980:	d0c50513          	addi	a0,a0,-756 # 7688 <loop+0x14b2>
  ...
  if (unlink("dd/xx/ff") == 0) {
    ...
    3994:	eb050513          	addi	a0,a0,-336 # 7840 <loop+0x166a>
  ...
  if (unlink("dd/ff/ff") == 0) {
    ...
    39a8:	e6c50513          	addi	a0,a0,-404 # 7810 <loop+0x163a>
  ...
  if (chdir("dd/ff") == 0) {
    ...
    39bc:	bc850513          	addi	a0,a0,-1080 # 7580 <loop+0x13aa>
  ...
  if (chdir("dd/xx") == 0) {
    ...
    39d0:	05450513          	addi	a0,a0,84 # 7a20 <loop+0x184a>
  ...
  if (unlink("dd/dd/ffff") != 0) {
    ...
    39e4:	ca850513          	addi	a0,a0,-856 # 7688 <loop+0x14b2>
  ...
  if (unlink("dd/ff") != 0) {
    ...
    39f8:	b8c50513          	addi	a0,a0,-1140 # 7580 <loop+0x13aa>
  ...
  if (unlink("dd") == 0) {
    ...
    3a0c:	b5850513          	addi	a0,a0,-1192 # 7560 <loop+0x138a>
  ...
  if (unlink("dd/dd") < 0) {
    ...
    3a20:	07450513          	addi	a0,a0,116 # 7a90 <loop+0x18ba>
  ...
  if (unlink("dd") < 0) {
    ...
    3a34:	b3050513          	addi	a0,a0,-1232 # 7560 <loop+0x138a>
    ...
    3a56:	b1650513          	addi	a0,a0,-1258 # 7568 <loop+0x1392>
    ...
    3a72:	b1a50513          	addi	a0,a0,-1254 # 7588 <loop+0x13b2>
    ...
    3a8e:	b1e50513          	addi	a0,a0,-1250 # 75a8 <loop+0x13d2>
    ...
    3aaa:	b3a50513          	addi	a0,a0,-1222 # 75e0 <loop+0x140a>
    ...
    3ac6:	b4e50513          	addi	a0,a0,-1202 # 7610 <loop+0x143a>
    ...
    3ae2:	b6a50513          	addi	a0,a0,-1174 # 7648 <loop+0x1472>
    ...
    3afe:	b6e50513          	addi	a0,a0,-1170 # 7668 <loop+0x1492>
    ...
    3b1a:	b8250513          	addi	a0,a0,-1150 # 7698 <loop+0x14c2>
    ...
    3b36:	b8e50513          	addi	a0,a0,-1138 # 76c0 <loop+0x14ea>
    ...
    3b52:	b9250513          	addi	a0,a0,-1134 # 76e0 <loop+0x150a>
    ...
    3b6e:	b9e50513          	addi	a0,a0,-1122 # 7708 <loop+0x1532>
    ...
    3b8a:	baa50513          	addi	a0,a0,-1110 # 7730 <loop+0x155a>
    ...
    3ba6:	bbe50513          	addi	a0,a0,-1090 # 7760 <loop+0x158a>
    ...
    3bc2:	bca50513          	addi	a0,a0,-1078 # 7788 <loop+0x15b2>
    ...
    3bde:	bc650513          	addi	a0,a0,-1082 # 77a0 <loop+0x15ca>
    ...
    3bfa:	bca50513          	addi	a0,a0,-1078 # 77c0 <loop+0x15ea>
    ...
    3c16:	bce50513          	addi	a0,a0,-1074 # 77e0 <loop+0x160a>
    ...
    3c32:	bf250513          	addi	a0,a0,-1038 # 7820 <loop+0x164a>
    ...
    3c4e:	c0650513          	addi	a0,a0,-1018 # 7850 <loop+0x167a>
    ...
    3c6a:	c0a50513          	addi	a0,a0,-1014 # 7870 <loop+0x169a>
    ...
    3c86:	c0e50513          	addi	a0,a0,-1010 # 7890 <loop+0x16ba>
    ...
    3ca2:	c1250513          	addi	a0,a0,-1006 # 78b0 <loop+0x16da>
    ...
    3cbe:	c2650513          	addi	a0,a0,-986 # 78e0 <loop+0x170a>
    ...
    3cda:	c3250513          	addi	a0,a0,-974 # 7908 <loop+0x1732>
    ...
    3cf6:	c3e50513          	addi	a0,a0,-962 # 7930 <loop+0x175a>
    ...
    3d12:	c4a50513          	addi	a0,a0,-950 # 7958 <loop+0x1782>
    ...
    3d2e:	c4e50513          	addi	a0,a0,-946 # 7978 <loop+0x17a2>
    ...
    3d4a:	c5250513          	addi	a0,a0,-942 # 7998 <loop+0x17c2>
    ...
    3d66:	c5e50513          	addi	a0,a0,-930 # 79c0 <loop+0x17ea>
    ...
    3d82:	c6250513          	addi	a0,a0,-926 # 79e0 <loop+0x180a>
    ...
    3d9e:	c6650513          	addi	a0,a0,-922 # 7a00 <loop+0x182a>
    ...
    3dba:	c7250513          	addi	a0,a0,-910 # 7a28 <loop+0x1852>
    ...
    3dd6:	8ee50513          	addi	a0,a0,-1810 # 76c0 <loop+0x14ea>
    ...
    3df2:	c5a50513          	addi	a0,a0,-934 # 7a48 <loop+0x1872>
    ...
    3e0e:	c5e50513          	addi	a0,a0,-930 # 7a68 <loop+0x1892>
    ...
    3e2a:	c7250513          	addi	a0,a0,-910 # 7a98 <loop+0x18c2>
    ...
    3e46:	c7650513          	addi	a0,a0,-906 # 7ab8 <loop+0x18e2>
...
void rmdot(char *s) {
  ...
  if (mkdir("dots") != 0) {
    ...
    3e6c:	c6850513          	addi	a0,a0,-920 # 7ad0 <loop+0x18fa>
  ...
  if (chdir("dots") != 0) {
    ...
    3e7e:	c5650513          	addi	a0,a0,-938 # 7ad0 <loop+0x18fa>
  ...
  if (unlink(".") == 0) {
    ...
    3e90:	a7450513          	addi	a0,a0,-1420 # 6900 <loop+0x72a>
  ...
  if (unlink("..") == 0) {
    ...
    3ea2:	68a50513          	addi	a0,a0,1674 # 7528 <loop+0x1352>
  ...
  if (chdir("/") != 0) {
    ...
    3eb4:	62050513          	addi	a0,a0,1568 # 74d0 <loop+0x12fa>
  ...
  if (unlink("dots/.") == 0) {
    ...
    3ec6:	c7650513          	addi	a0,a0,-906 # 7b38 <loop+0x1962>
  ...
  if (unlink("dots/..") == 0) {
    ...
    3ed8:	c8c50513          	addi	a0,a0,-884 # 7b60 <loop+0x198a>
  ...
  if (unlink("dots") != 0) {
    ...
    3eea:	bea50513          	addi	a0,a0,-1046 # 7ad0 <loop+0x18fa>
    ...
    3f08:	bd450513          	addi	a0,a0,-1068 # 7ad8 <loop+0x1902>
    ...
    3f24:	bd050513          	addi	a0,a0,-1072 # 7af0 <loop+0x191a>
    ...
    3f40:	bcc50513          	addi	a0,a0,-1076 # 7b08 <loop+0x1932>
    ...
    3f5c:	bc850513          	addi	a0,a0,-1080 # 7b20 <loop+0x194a>
    ...
    3f78:	56450513          	addi	a0,a0,1380 # 74d8 <loop+0x1302>
    ...
    3f94:	bb050513          	addi	a0,a0,-1104 # 7b40 <loop+0x196a>
    ...
    3fb0:	bbc50513          	addi	a0,a0,-1092 # 7b68 <loop+0x1992>
    ...
    3fcc:	bc050513          	addi	a0,a0,-1088 # 7b88 <loop+0x19b2>
...
void dirfile(char *s) {
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	bb450513          	addi	a0,a0,-1100 # 7ba8 <loop+0x19d2>
  ...
  if (chdir("dirfile") == 0) {
    ...
    4014:	b9850513          	addi	a0,a0,-1128 # 7ba8 <loop+0x19d2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	bcc50513          	addi	a0,a0,-1076 # 7bf0 <loop+0x1a1a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	bb450513          	addi	a0,a0,-1100 # 7bf0 <loop+0x1a1a>
  ...
  if (mkdir("dirfile/xx") == 0) {
    ...
    4054:	ba050513          	addi	a0,a0,-1120 # 7bf0 <loop+0x1a1a>
  ...
  if (unlink("dirfile/xx") == 0) {
    ...
    4068:	b8c50513          	addi	a0,a0,-1140 # 7bf0 <loop+0x1a1a>
  ...
  if (link("README", "dirfile/xx") == 0) {
    ...
    407c:	b7858593          	addi	a1,a1,-1160 # 7bf0 <loop+0x1a1a>
    4080:	00002517          	auipc	a0,0x2
    4084:	37050513          	addi	a0,a0,880 # 63f0 <loop+0x21a>
  ...
  if (unlink("dirfile") != 0) {
    ...
    4098:	b1450513          	addi	a0,a0,-1260 # 7ba8 <loop+0x19d2>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	85650513          	addi	a0,a0,-1962 # 6900 <loop+0x72a>
  ...
  fd = open(".", 0);
    ...
    40c4:	84050513          	addi	a0,a0,-1984 # 6900 <loop+0x72a>
  ...
  if (write(fd, "x", 1) > 0) {
    ...
    40d8:	1b458593          	addi	a1,a1,436 # 6288 <loop+0xb2>
  ...
  close(fd);
    ...
    4104:	ab050513          	addi	a0,a0,-1360 # 7bb0 <loop+0x19da>
    ...
    4120:	ab450513          	addi	a0,a0,-1356 # 7bd0 <loop+0x19fa>
    ...
    413c:	ac850513          	addi	a0,a0,-1336 # 7c00 <loop+0x1a2a>
    ...
    4158:	aac50513          	addi	a0,a0,-1364 # 7c00 <loop+0x1a2a>
    ...
    4174:	ab850513          	addi	a0,a0,-1352 # 7c28 <loop+0x1a52>
    ...
    4190:	ac450513          	addi	a0,a0,-1340 # 7c50 <loop+0x1a7a>
    ...
    41ac:	ad050513          	addi	a0,a0,-1328 # 7c78 <loop+0x1aa2>
    ...
    41c8:	adc50513          	addi	a0,a0,-1316 # 7ca0 <loop+0x1aca>
    ...
    41e4:	ae050513          	addi	a0,a0,-1312 # 7cc0 <loop+0x1aea>
    ...
    4200:	aec50513          	addi	a0,a0,-1300 # 7ce8 <loop+0x1b12>
...
void iref(char *s) {
    ...
    4234:	ad0a0a13          	addi	s4,s4,-1328 # 7d00 <loop+0x1b2a>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	5d048493          	addi	s1,s1,1488 # 7808 <loop+0x1632>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	1b0a8a93          	addi	s5,s5,432 # 63f0 <loop+0x21a>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	9b098993          	addi	s3,s3,-1616 # 7bf8 <loop+0x1a22>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	ab450513          	addi	a0,a0,-1356 # 7d08 <loop+0x1b32>
    ...
    4274:	ab050513          	addi	a0,a0,-1360 # 7d20 <loop+0x1b4a>
  ...
  for (i = 0; i < NINODE + 1; i++) {
    ...
    4308:	22498993          	addi	s3,s3,548 # 7528 <loop+0x1352>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	9f490913          	addi	s2,s2,-1548 # 7d00 <loop+0x1b2a>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	1a450513          	addi	a0,a0,420 # 74d0 <loop+0x12fa>
...
void openiputtest(char *s) {
  ...
  if (mkdir("oidir") < 0) {
    ...
    4360:	9dc50513          	addi	a0,a0,-1572 # 7d38 <loop+0x1b62>
  ...
  if (pid == 0) {
    ...
    4384:	9b850513          	addi	a0,a0,-1608 # 7d38 <loop+0x1b62>
    ...
    439a:	9c250513          	addi	a0,a0,-1598 # 7d58 <loop+0x1b82>
    ...
    43b6:	98e50513          	addi	a0,a0,-1650 # 7d40 <loop+0x1b6a>
    ...
    43d2:	6d250513          	addi	a0,a0,1746 # 6aa0 <loop+0x8ca>
  ...
  if (unlink("oidir") != 0) {
    ...
    4400:	93c50513          	addi	a0,a0,-1732 # 7d38 <loop+0x1b62>
    ...
    4414:	88050513          	addi	a0,a0,-1920 # 6c90 <loop+0xaba>
...
void forkforkfork(char *s) {
  ...
  unlink("stopforking");
    ...
    4452:	93250513          	addi	a0,a0,-1742 # 7d80 <loop+0x1baa>
  ...
  close(open("stopforking", O_CREATE | O_RDWR));
    ...
    447e:	90650513          	addi	a0,a0,-1786 # 7d80 <loop+0x1baa>
  ...
  sleep(10);  // one second
    ...
    44b6:	7ae50513          	addi	a0,a0,1966 # 6c60 <loop+0xa8a>
    ...
    44d0:	8b448493          	addi	s1,s1,-1868 # 7d80 <loop+0x1baa>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
void killstatus(char *s) {
  ...
  exit(0);
    ...
    4578:	52c50513          	addi	a0,a0,1324 # 6aa0 <loop+0x8ca>
    ...
    459e:	7f650513          	addi	a0,a0,2038 # 7d90 <loop+0x1bba>
...
void preempt(char *s) {
  ...
  if (pid1 == 0)
    ...
    45de:	68650513          	addi	a0,a0,1670 # 6c60 <loop+0xa8a>
  ...
  if (pid2 == 0)
    ...
    460c:	49850513          	addi	a0,a0,1176 # 6aa0 <loop+0x8ca>
  ...
  if (pid3 == 0) {
    ...
    4650:	c3c58593          	addi	a1,a1,-964 # 6288 <loop+0xb2>
    ...
    467a:	42a50513          	addi	a0,a0,1066 # 6aa0 <loop+0x8ca>
    ...
    4696:	71e50513          	addi	a0,a0,1822 # 7db0 <loop+0x1bda>
  ...
  if (read(pfds[0], buf, sizeof(buf)) != 1) {
    ...
    46d2:	6fa50513          	addi	a0,a0,1786 # 7dc8 <loop+0x1bf2>
  ...
  printf("kill... ");
    ...
    46fe:	6e650513          	addi	a0,a0,1766 # 7de0 <loop+0x1c0a>
  ...
  printf("wait... ");
    ...
    472c:	6c850513          	addi	a0,a0,1736 # 7df0 <loop+0x1c1a>
...
void reparent(char *s) {
  ...
  exit(0);
    ...
    47ac:	2f850513          	addi	a0,a0,760 # 6aa0 <loop+0x8ca>
    ...
    47c8:	46450513          	addi	a0,a0,1124 # 6c28 <loop+0xa52>
...
void sbrkfail(char *s) {
  ...
  if (pipe(fds) != 0) {
    ...
    483e:	36e50513          	addi	a0,a0,878 # 6ba8 <loop+0x9d2>
    ...
    4872:	a1a58593          	addi	a1,a1,-1510 # 6288 <loop+0xb2>
  ...
  if (xstatus != -1 && xstatus != 2) exit(1);
    ...
    4936:	4ce50513          	addi	a0,a0,1230 # 7e00 <loop+0x1c2a>
    ...
    4952:	15250513          	addi	a0,a0,338 # 6aa0 <loop+0x8ca>
    ...
    499e:	48650513          	addi	a0,a0,1158 # 7e20 <loop+0x1c4a>
...
void mem(char *s) {
  ...
  if ((pid = fork()) == 0) {
    ...
    4a42:	41250513          	addi	a0,a0,1042 # 7e50 <loop+0x1c7a>
...
void sharedfd(char *s) {
  ...
  if (pid == 0) {
    ...
    4af8:	38c50513          	addi	a0,a0,908 # 7e80 <loop+0x1caa>
    ...
    4b14:	39850513          	addi	a0,a0,920 # 7ea8 <loop+0x1cd2>
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	31c50513          	addi	a0,a0,796 # 7e70 <loop+0x1c9a>
  ...
  while ((n = read(fd, buf, sizeof(buf))) > 0) {
    ...
    4b98:	33450513          	addi	a0,a0,820 # 7ec8 <loop+0x1cf2>
  ...
  unlink("sharedfd");
    ...
    4bd4:	2a050513          	addi	a0,a0,672 # 7e70 <loop+0x1c9a>
  ...
  if (nc == N * SZ && np == N * SZ) {
    ...
    4bfa:	2fa50513          	addi	a0,a0,762 # 7ef0 <loop+0x1d1a>
...
void fourfiles(char *s) {
  ...
  char *names[] = {"f0", "f1", "f2", "f3"};
    ...
    4c40:	2cc78793          	addi	a5,a5,716 # 7f08 <loop+0x1d32>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	2c878793          	addi	a5,a5,712 # 7f10 <loop+0x1d3a>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	2c478793          	addi	a5,a5,708 # 7f18 <loop+0x1d42>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	2c078793          	addi	a5,a5,704 # 7f20 <loop+0x1d4a>
  ...
  for (i = 0; i < NCHILD; i++) {
    ...
    4cdc:	1d050513          	addi	a0,a0,464 # 6ea8 <loop+0xcd2>
    ...
    4d58:	1d450513          	addi	a0,a0,468 # 7f28 <loop+0x1d52>
    ...
    4d72:	1ca50513          	addi	a0,a0,458 # 7f38 <loop+0x1d62>
    ...
    4d9a:	1ba50513          	addi	a0,a0,442 # 7f50 <loop+0x1d7a>
  ...
  for (i = 0; i < NCHILD; i++) {
    ...
    4e28:	13c50513          	addi	a0,a0,316 # 7f60 <loop+0x1d8a>
...
void concreate(char *s) {
  ...
  for (i = 0; i < N; i++) {
    ...
    4e8a:	0f2b8b93          	addi	s7,s7,242 # 7f78 <loop+0x1da2>
  for (i = 0; i < N; i++) {
    ...
    4ecc:	0b850513          	addi	a0,a0,184 # 7f80 <loop+0x1daa>
    ...
    4eea:	09250513          	addi	a0,a0,146 # 7f78 <loop+0x1da2>
  ...
  fd = open(".", 0);
    ...
    4f22:	9e250513          	addi	a0,a0,-1566 # 6900 <loop+0x72a>
  ...
  while (read(fd, &de, sizeof(de)) > 0) {
    ...
    4f9a:	00a50513          	addi	a0,a0,10 # 7fa0 <loop+0x1dca>
    ...
    4fba:	00a50513          	addi	a0,a0,10 # 7fc0 <loop+0x1dea>
  ...
  for (i = 0; i < N; i++) {
    ...
    4ff2:	ffa50513          	addi	a0,a0,-6 # 7fe8 <loop+0x1e12>
    ...
    500e:	a9650513          	addi	a0,a0,-1386 # 6aa0 <loop+0x8ca>
...
void bigfile(char *s) {
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	de450513          	addi	a0,a0,-540 # 8020 <loop+0x1e4a>
  ...
  for (i = 0;; i++) {
    ...
    52a4:	d9050513          	addi	a0,a0,-624 # 8030 <loop+0x1e5a>
    ...
    52c0:	d9450513          	addi	a0,a0,-620 # 8050 <loop+0x1e7a>
    ...
    52dc:	d9850513          	addi	a0,a0,-616 # 8070 <loop+0x1e9a>
    ...
    52f8:	d9c50513          	addi	a0,a0,-612 # 8090 <loop+0x1eba>
    ...
    5314:	da050513          	addi	a0,a0,-608 # 80b0 <loop+0x1eda>
    ...
    5330:	d9c50513          	addi	a0,a0,-612 # 80c8 <loop+0x1ef2>
  ...
  unlink("bigfile.dat");
    ...
    535e:	cc650513          	addi	a0,a0,-826 # 8020 <loop+0x1e4a>
    ...
    5382:	d6a50513          	addi	a0,a0,-662 # 80e8 <loop+0x1f12>
...
void fsfull() {
  ...
  printf("fsfull test\n");
    ...
    53ba:	d5250513          	addi	a0,a0,-686 # 8108 <loop+0x1f32>
  ...
  for (nfiles = 0;; nfiles++) {
    ...
    53da:	d42c8c93          	addi	s9,s9,-702 # 8118 <loop+0x1f42>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	cd850513          	addi	a0,a0,-808 # 8128 <loop+0x1f52>
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	c8250513          	addi	a0,a0,-894 # 8148 <loop+0x1f72>
    ...
    551a:	c2250513          	addi	a0,a0,-990 # 8138 <loop+0x1f62>
...
int run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	c1850513          	addi	a0,a0,-1000 # 8160 <loop+0x1f8a>
  ...
  if (pid == 0) {
    ...
    557c:	c1050513          	addi	a0,a0,-1008 # 8188 <loop+0x1fb2>
    ...
    55a0:	bd450513          	addi	a0,a0,-1068 # 8170 <loop+0x1f9a>
    ...
    55c8:	bcc50513          	addi	a0,a0,-1076 # 8190 <loop+0x1fba>
...
int runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	b8450513          	addi	a0,a0,-1148 # 8198 <loop+0x1fc2>
...
int countfree() {
  ...
  if (pid == 0) {
    ...
    5672:	c1a98993          	addi	s3,s3,-998 # 6288 <loop+0xb2>
      uint64 a = (uint64)sbrk(4096);
    ...
    56a4:	b5050513          	addi	a0,a0,-1200 # 81f0 <loop+0x201a>
    ...
    56be:	af650513          	addi	a0,a0,-1290 # 81b0 <loop+0x1fda>
    ...
    56d8:	afc50513          	addi	a0,a0,-1284 # 81d0 <loop+0x1ffa>
  ...
  while (1) {
    ...
    5726:	aee50513          	addi	a0,a0,-1298 # 8210 <loop+0x203a>
...
int drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	aacb8b93          	addi	s7,s7,-1364 # 8230 <loop+0x205a>
    int free0 = countfree();
    int free1 = 0;
    ...
    579a:	ad2c8c93          	addi	s9,s9,-1326 # 8268 <loop+0x2092>
    ...
    57aa:	aa2d0d13          	addi	s10,s10,-1374 # 8248 <loop+0x2072>
...
int main(int argc, char *argv[]) {
  ...
  if (argc == 2 && strcmp(argv[1], "-q") == 0) {
    ...
    589e:	9fe58593          	addi	a1,a1,-1538 # 8298 <loop+0x20c2>
    ...
    58b6:	a3e58593          	addi	a1,a1,-1474 # 82f0 <loop+0x211a>
    ...
    58cc:	a2058593          	addi	a1,a1,-1504 # 82e8 <loop+0x2112>
  ...
  int continuous = 0;
    ...
    58f8:	9ac50513          	addi	a0,a0,-1620 # 82a0 <loop+0x20ca>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	9b050513          	addi	a0,a0,-1616 # 82d0 <loop+0x20fa>
...
static void printint(int fd, int xx, int base, int sgn) {
  ...
  do {
    ...
    5cb8:	a0450513          	addi	a0,a0,-1532 # 86b8 <digits>
    5cbc:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
  ...
  state = 0;
    ...
    5d78:	8ecc8c93          	addi	s9,s9,-1812 # 8660 <loop+0x248a>
      } else if (c == 'p') {
  ...
  putc(fd, 'x');
    ...
    5d86:	936b8b93          	addi	s7,s7,-1738 # 86b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eac:	7b098993          	addi	s3,s3,1968 # 8658 <loop+0x2482>
        while (*s != 0) {
    5eb0:	85ee                	mv	a1,s11
...
00000000000060e8 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000006104 <dump_test3_asm>:
...
dump_test3_asm:
  ...
  li s3, -12
    6106:	59d1                	li	s3,-12
  li s4, 123
    6108:	07b00a13          	li	s4,123
  li s5, -1234
    610c:	b2e00a93          	li	s5,-1234
  li s6, 12345
    6110:	6b0d                	lui	s6,0x3
    6112:	039b0b1b          	addiw	s6,s6,57 # 3039 <fourteen+0x1b>
  li s7, -123456
    6116:	7b89                	lui	s7,0xfffe2
    6118:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffd2148>
  li s8, 1234567
    611c:	0012dc37          	lui	s8,0x12d
    6120:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x11da0f>
  li s9, -12345678
    6124:	ff43acb7          	lui	s9,0xff43a
    6128:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff42a23a>
  li s10, 123456789
    612c:	075bdd37          	lui	s10,0x75bd
    6130:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75ad09d>
  li s11, -1234567890
    6134:	b66a0db7          	lui	s11,0xb66a0
    6138:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb66900b6>
#ifdef SYS_dump
  li a7, SYS_dump
    613c:	48d9                	li	a7,22
  ecall
...
0000000000006144 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
    6144:	80000937          	lui	s2,0x80000
    6148:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fff0387>
  li s3, -2147483648
    614a:	800009b7          	lui	s3,0x80000
  li s4, 1337
    614e:	53900a13          	li	s4,1337
  li s5, 2020
    6152:	7e400a93          	li	s5,2020
  li s6, 3234
    6156:	6b05                	lui	s6,0x1
    6158:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <writebig+0x11a>
  li s7, 3235
    615c:	6b85                	lui	s7,0x1
    615e:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <writebig+0x11b>
  li s8, 3236
    6162:	6c05                	lui	s8,0x1
    6164:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <writebig+0x11c>
  li s9, 3237
    6168:	6c85                	lui	s9,0x1
    616a:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <writebig+0x11d>
  li s10, 3238
    616e:	6d05                	lui	s10,0x1
    6170:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <writebig+0x11e>
  li s11, 3239
    6174:	6d85                	lui	s11,0x1
    6176:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <writebig+0x11f>
#ifdef SYS_dump
  li a7, SYS_dump
    617a:	48d9                	li	a7,22
  ecall
...
0000000000006182 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
dump2_test1_asm:
  ...
  ecall
    6198:	00000073          	ecall
  j loop
    619c:	a82d                	j	61d6 <loop>

000000000000619e <dump2_test2_asm>:
...
dump2_test2_asm:
  ...
  li s5, 25
    61a4:	4ae5                	li	s5,25
  li s6, 36
    61a6:	02400b13          	li	s6,36
  li s7, 49
    61aa:	03100b93          	li	s7,49
  li s8, 64
    61ae:	04000c13          	li	s8,64
  li s9, 81
    61b2:	05100c93          	li	s9,81
  li s10, 100
    61b6:	06400d13          	li	s10,100
  li s11, 121
    61ba:	07900d93          	li	s11,121
  li a7, SYS_write
    61be:	48c1                	li	a7,16
  ecall
    61c0:	00000073          	ecall
  j loop
    61c4:	a809                	j	61d6 <loop>

00000000000061c6 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
    61c6:	53900913          	li	s2,1337
  mv a2, a1
    61ca:	862e                	mv	a2,a1
  li a1, 2
    61cc:	4589                	li	a1,2
...
00000000000061d6 <loop>:

loop:
  j loop
    61d6:	a001                	j	61d6 <loop>
  ret
    61d8:	8082                	ret
