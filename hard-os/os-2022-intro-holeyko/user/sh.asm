...
int getcmd(char *buf, int nbuf) {
  ...
  write(2, "$ ", 2);
      ...
      16:	3ee58593          	addi	a1,a1,1006 # 1400 <loop+0x6>
      1a:	4509                	li	a0,2
...
void panic(char *s) {
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	3a858593          	addi	a1,a1,936 # 1408 <loop+0xe>
      68:	4509                	li	a0,2
...
int fork1(void) {
  ...
  if (pid == -1) panic("fork");
      ...
      9e:	37650513          	addi	a0,a0,886 # 1410 <loop+0x16>
...
void runcmd(struct cmd *cmd) {
  ...
  switch (cmd->type) {
      ...
      ca:	44a70713          	addi	a4,a4,1098 # 1510 <loop+0x116>
  ...
  if (cmd == 0) exit(1);
      ...
      e4:	33850513          	addi	a0,a0,824 # 1418 <loop+0x1e>
     ...
     106:	31e58593          	addi	a1,a1,798 # 1420 <loop+0x26>
     10a:	4509                	li	a0,2
  ...
  exit(0);
     ...
     152:	2e258593          	addi	a1,a1,738 # 1430 <loop+0x36>
     156:	4509                	li	a0,2
     ...
     1e8:	25c50513          	addi	a0,a0,604 # 1440 <loop+0x46>
...
struct cmd *parseredirs(struct cmd *cmd, char **ps, char *es) {
  ...
  while (peek(ps, es, "<>")) {
     ...
     5b0:	ebcb8b93          	addi	s7,s7,-324 # 1468 <loop+0x6e>
  ...
  while (peek(ps, es, "<>")) {
    ...
    if (gettoken(ps, es, &q, &eq) != 'a') panic("missing file for redirection");
     ...
     5c2:	e8a50513          	addi	a0,a0,-374 # 1448 <loop+0x4e>
...
struct cmd *parseexec(char **ps, char *es) {
  ...
  if (peek(ps, es, "(")) return parseblock(ps, es);
     ...
     6aa:	dca60613          	addi	a2,a2,-566 # 1470 <loop+0x76>
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     6da:	dbab0b13          	addi	s6,s6,-582 # 1490 <loop+0x96>
  ...
  return ret;
    ...
    if (tok != 'a') panic("syntax");
     ...
     714:	d6850513          	addi	a0,a0,-664 # 1478 <loop+0x7e>
  ...
  while (!peek(ps, es, "|)&;")) {
    ...
    if (argc >= MAXARGS) panic("too many args");
     ...
     776:	d0e50513          	addi	a0,a0,-754 # 1480 <loop+0x86>
...
struct cmd *parsepipe(char **ps, char *es) {
  ...
  if (peek(ps, es, "|")) {
     ...
     7b0:	cec60613          	addi	a2,a2,-788 # 1498 <loop+0x9e>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
struct cmd *parseline(char **ps, char *es) {
  ...
  while (peek(ps, es, "&")) {
     ...
     820:	c84a0a13          	addi	s4,s4,-892 # 14a0 <loop+0xa6>
  ...
  if (peek(ps, es, ";")) {
     ...
     856:	c5660613          	addi	a2,a2,-938 # 14a8 <loop+0xae>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
struct cmd *parseblock(char **ps, char *es) {
  ...
  if (!peek(ps, es, "(")) panic("parseblock");
     ...
     8bc:	bb860613          	addi	a2,a2,-1096 # 1470 <loop+0x76>
  ...
  if (!peek(ps, es, ")")) panic("syntax - missing )");
     ...
     8ec:	bd860613          	addi	a2,a2,-1064 # 14c0 <loop+0xc6>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
...
struct cmd *nulterminate(struct cmd *cmd) {
  ...
  switch (cmd->type) {
     ...
     96a:	bc270713          	addi	a4,a4,-1086 # 1528 <loop+0x12e>
...
struct cmd *parsecmd(char *s) {
  ...
  peek(&s, es, "");
     ...
     a16:	ace60613          	addi	a2,a2,-1330 # 14e0 <loop+0xe6>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	aa058593          	addi	a1,a1,-1376 # 14e8 <loop+0xee>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	6ee080e7          	jalr	1774(ra) # 1140 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	a1e50513          	addi	a0,a0,-1506 # 1478 <loop+0x7e>
...
int main(void) {
  ...
  while ((fd = open("console", O_RDWR)) >= 0) {
     ...
     a80:	a7c48493          	addi	s1,s1,-1412 # 14f8 <loop+0xfe>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while (getcmd(buf, sizeof(buf)) >= 0) {
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
     ...
     abe:	a46a8a93          	addi	s5,s5,-1466 # 1500 <loop+0x106>
...
static void printint(int fd, int xx, int base, int sgn) {
  ...
  do {
    buf[i++] = digits[x % base];
     ...
     edc:	6c850513          	addi	a0,a0,1736 # 15a0 <digits>
     ee0:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
  ...
  state = 0;
     ...
     f9c:	5b0c8c93          	addi	s9,s9,1456 # 1548 <loop+0x14e>
      } else if (c == 'p') {
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     faa:	5fab8b93          	addi	s7,s7,1530 # 15a0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d0:	47498993          	addi	s3,s3,1140 # 1540 <loop+0x146>
        while (*s != 0) {
    10d4:	85ee                	mv	a1,s11
...
000000000000130c <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000001328 <dump_test3_asm>:
...
dump_test3_asm:
  ...
  li s3, -12
    132a:	59d1                	li	s3,-12
  li s4, 123
    132c:	07b00a13          	li	s4,123
  li s5, -1234
    1330:	b2e00a93          	li	s5,-1234
  li s6, 12345
    1334:	6b0d                	lui	s6,0x3
    1336:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0xfb1>
  li s7, -123456
    133a:	7b89                	lui	s7,0xfffe2
    133c:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffdfd38>
  li s8, 1234567
    1340:	0012dc37          	lui	s8,0x12d
    1344:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12b5ff>
  li s9, -12345678
    1348:	ff43acb7          	lui	s9,0xff43a
    134c:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff437e2a>
  li s10, 123456789
    1350:	075bdd37          	lui	s10,0x75bd
    1354:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bac8d>
  li s11, -1234567890
    1358:	b66a0db7          	lui	s11,0xb66a0
    135c:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669dca6>
#ifdef SYS_dump
  li a7, SYS_dump
    1360:	48d9                	li	a7,22
  ecall
...
0000000000001368 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
    1368:	80000937          	lui	s2,0x80000
    136c:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffdf77>
  li s3, -2147483648
    136e:	800009b7          	lui	s3,0x80000
  li s4, 1337
    1372:	53900a13          	li	s4,1337
  li s5, 2020
    1376:	7e400a93          	li	s5,2020
  li s6, 3234
    137a:	6b05                	lui	s6,0x1
    137c:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <gets+0x72>
  li s7, 3235
    1380:	6b85                	lui	s7,0x1
    1382:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <gets+0x73>
  li s8, 3236
    1386:	6c05                	lui	s8,0x1
    1388:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <stat>
  li s9, 3237
    138c:	6c85                	lui	s9,0x1
    138e:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <stat+0x1>
  li s10, 3238
    1392:	6d05                	lui	s10,0x1
    1394:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <stat+0x2>
  li s11, 3239
    1398:	6d85                	lui	s11,0x1
    139a:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <stat+0x3>
#ifdef SYS_dump
  li a7, SYS_dump
    139e:	48d9                	li	a7,22
  ecall
...
00000000000013a6 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
dump2_test1_asm:
  ...
  ecall
    13bc:	00000073          	ecall
  j loop
    13c0:	a82d                	j	13fa <loop>

00000000000013c2 <dump2_test2_asm>:
...
dump2_test2_asm:
  ...
  li s5, 25
    13c8:	4ae5                	li	s5,25
  li s6, 36
    13ca:	02400b13          	li	s6,36
  li s7, 49
    13ce:	03100b93          	li	s7,49
  li s8, 64
    13d2:	04000c13          	li	s8,64
  li s9, 81
    13d6:	05100c93          	li	s9,81
  li s10, 100
    13da:	06400d13          	li	s10,100
  li s11, 121
    13de:	07900d93          	li	s11,121
  li a7, SYS_write
    13e2:	48c1                	li	a7,16
  ecall
    13e4:	00000073          	ecall
  j loop
    13e8:	a809                	j	13fa <loop>

00000000000013ea <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
    13ea:	53900913          	li	s2,1337
  mv a2, a1
    13ee:	862e                	mv	a2,a1
  li a1, 2
    13f0:	4589                	li	a1,2
...
00000000000013fa <loop>:

loop:
  j loop
    13fa:	a001                	j	13fa <loop>
  ret
    13fc:	8082                	ret
