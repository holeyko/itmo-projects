...
int main(int argc, char *argv[]) {
  ...
  42:	8e258593          	addi	a1,a1,-1822 # 920 <loop+0xc>
  46:	4509                	li	a0,2
  ...
  60:	8dc58593          	addi	a1,a1,-1828 # 938 <loop+0x24>
  64:	4509                	li	a0,2
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3f6:	5c650513          	addi	a0,a0,1478 # 9b8 <digits>
 3fa:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 4b6:	4aec8c93          	addi	s9,s9,1198 # 960 <loop+0x4c>
      } else if (c == 'p') {
 ...
 4c4:	4f8b8b93          	addi	s7,s7,1272 # 9b8 <digits>
 ...
 5ea:	37298993          	addi	s3,s3,882 # 958 <loop+0x44>
        while (*s != 0) {
 5ee:	85ee                	mv	a1,s11
...
0000000000000826 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000000842 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 844:	59d1                	li	s3,-12
  li s4, 123
 846:	07b00a13          	li	s4,123
  li s5, -1234
 84a:	b2e00a93          	li	s5,-1234
  li s6, 12345
 84e:	6b0d                	lui	s6,0x3
 850:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 854:	7b89                	lui	s7,0xfffe2
 856:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 85a:	0012dc37          	lui	s8,0x12d
 85e:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 862:	ff43acb7          	lui	s9,0xff43a
 866:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 86a:	075bdd37          	lui	s10,0x75bd
 86e:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 872:	b66a0db7          	lui	s11,0xb66a0
 876:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 87a:	48d9                	li	a7,22
  ecall
...
0000000000000882 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 882:	80000937          	lui	s2,0x80000
 886:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 888:	800009b7          	lui	s3,0x80000
  li s4, 1337
 88c:	53900a13          	li	s4,1337
  li s5, 2020
 890:	7e400a93          	li	s5,2020
  li s6, 3234
 894:	6b05                	lui	s6,0x1
 896:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x2ea>
  li s7, 3235
 89a:	6b85                	lui	s7,0x1
 89c:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x2eb>
  li s8, 3236
 8a0:	6c05                	lui	s8,0x1
 8a2:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x2ec>
  li s9, 3237
 8a6:	6c85                	lui	s9,0x1
 8a8:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x2ed>
  li s10, 3238
 8ac:	6d05                	lui	s10,0x1
 8ae:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x2ee>
  li s11, 3239
 8b2:	6d85                	lui	s11,0x1
 8b4:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x2ef>
#ifdef SYS_dump
  li a7, SYS_dump
 8b8:	48d9                	li	a7,22
  ecall
...
00000000000008c0 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
00000000000008dc <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 8e2:	4ae5                	li	s5,25
  li s6, 36
 8e4:	02400b13          	li	s6,36
  li s7, 49
 8e8:	03100b93          	li	s7,49
  li s8, 64
 8ec:	04000c13          	li	s8,64
  li s9, 81
 8f0:	05100c93          	li	s9,81
  li s10, 100
 8f4:	06400d13          	li	s10,100
  li s11, 121
 8f8:	07900d93          	li	s11,121
  li a7, SYS_write
 8fc:	48c1                	li	a7,16
  ecall
 8fe:	00000073          	ecall
...
0000000000000904 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 904:	53900913          	li	s2,1337
  mv a2, a1
 908:	862e                	mv	a2,a1
  li a1, 2
 90a:	4589                	li	a1,2
