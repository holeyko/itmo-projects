...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 3a8:	58c50513          	addi	a0,a0,1420 # 930 <digits>
 3ac:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
 ...
 468:	474c8c93          	addi	s9,s9,1140 # 8d8 <loop+0x12>
      } else if (c == 'p') {
 ...
 476:	4beb8b93          	addi	s7,s7,1214 # 930 <digits>
 ...
 59c:	33898993          	addi	s3,s3,824 # 8d0 <loop+0xa>
        while (*s != 0) {
 5a0:	85ee                	mv	a1,s11
...
00000000000007d8 <dump_test2_asm>:
#include "kernel/syscall.h"
...
00000000000007f4 <dump_test3_asm>:
...
dump_test3_asm:
 ...
 7f6:	59d1                	li	s3,-12
  li s4, 123
 7f8:	07b00a13          	li	s4,123
  li s5, -1234
 7fc:	b2e00a93          	li	s5,-1234
  li s6, 12345
 800:	6b0d                	lui	s6,0x3
 802:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0x2029>
  li s7, -123456
 806:	7b89                	lui	s7,0xfffe2
 808:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffe0db0>
  li s8, 1234567
 80c:	0012dc37          	lui	s8,0x12d
 810:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12c677>
  li s9, -12345678
 814:	ff43acb7          	lui	s9,0xff43a
 818:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff438ea2>
  li s10, 123456789
 81c:	075bdd37          	lui	s10,0x75bd
 820:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75bbd05>
  li s11, -1234567890
 824:	b66a0db7          	lui	s11,0xb66a0
 828:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669ed1e>
#ifdef SYS_dump
  li a7, SYS_dump
 82c:	48d9                	li	a7,22
  ecall
...
0000000000000834 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
 834:	80000937          	lui	s2,0x80000
 838:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffefef>
  li s3, -2147483648
 83a:	800009b7          	lui	s3,0x80000
  li s4, 1337
 83e:	53900a13          	li	s4,1337
  li s5, 2020
 842:	7e400a93          	li	s5,2020
  li s6, 3234
 846:	6b05                	lui	s6,0x1
 848:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <digits+0x372>
  li s7, 3235
 84c:	6b85                	lui	s7,0x1
 84e:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <digits+0x373>
  li s8, 3236
 852:	6c05                	lui	s8,0x1
 854:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <digits+0x374>
  li s9, 3237
 858:	6c85                	lui	s9,0x1
 85a:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <digits+0x375>
  li s10, 3238
 85e:	6d05                	lui	s10,0x1
 860:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <digits+0x376>
  li s11, 3239
 864:	6d85                	lui	s11,0x1
 866:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <digits+0x377>
#ifdef SYS_dump
  li a7, SYS_dump
 86a:	48d9                	li	a7,22
  ecall
...
0000000000000872 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
000000000000088e <dump2_test2_asm>:
...
dump2_test2_asm:
 ...
 894:	4ae5                	li	s5,25
  li s6, 36
 896:	02400b13          	li	s6,36
  li s7, 49
 89a:	03100b93          	li	s7,49
  li s8, 64
 89e:	04000c13          	li	s8,64
  li s9, 81
 8a2:	05100c93          	li	s9,81
  li s10, 100
 8a6:	06400d13          	li	s10,100
  li s11, 121
 8aa:	07900d93          	li	s11,121
  li a7, SYS_write
 8ae:	48c1                	li	a7,16
  ecall
 8b0:	00000073          	ecall
...
00000000000008b6 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
 8b6:	53900913          	li	s2,1337
  mv a2, a1
 8ba:	862e                	mv	a2,a1
  li a1, 2
 8bc:	4589                	li	a1,2
