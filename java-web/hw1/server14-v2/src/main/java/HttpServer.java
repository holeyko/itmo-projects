...
class HttpServer {
    ...
    private HttpServer(File root, int port, String defaultFileName) throws IOException {
        this.root = root;
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        if (file.isFile()) {
            ...
            if (request.getHeader("If-None-Match") == null || !request.getHeader("If-None-Match").equals(Integer.toString(Arrays.hashCode(body)))) {
