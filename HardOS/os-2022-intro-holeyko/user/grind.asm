...
void go(int which_child) {
  ...
  mkdir("grindir");
      ...
      9e:	3b650513          	addi	a0,a0,950 # 1450 <loop+0xc>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if (chdir("grindir") != 0) {
      aa:	00001517          	auipc	a0,0x1
      ae:	3a650513          	addi	a0,a0,934 # 1450 <loop+0xc>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	39c50513          	addi	a0,a0,924 # 1458 <loop+0x14>
  ...
  chdir("/");
      ...
      da:	3a250513          	addi	a0,a0,930 # 1478 <loop+0x34>
  ...
  while (1) {
    ...
    if ((iters % 500) == 0) write(1, which_child ? "B" : "A", 1);
      ...
      ea:	3a298993          	addi	s3,s3,930 # 1488 <loop+0x44>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	39098993          	addi	s3,s3,912 # 1480 <loop+0x3c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	63c90913          	addi	s2,s2,1596 # 1738 <loop+0x2f4>
    ...
    if (what == 1) {
     ...
     10e:	38650513          	addi	a0,a0,902 # 1490 <loop+0x4c>
    ...
    if (what == 1) {
     ...
     168:	33c50513          	addi	a0,a0,828 # 14a0 <loop+0x5c>
     ...
     182:	31250513          	addi	a0,a0,786 # 1490 <loop+0x4c>
     ...
     194:	2c050513          	addi	a0,a0,704 # 1450 <loop+0xc>
     ...
     1a6:	31650513          	addi	a0,a0,790 # 14b8 <loop+0x74>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	2c650513          	addi	a0,a0,710 # 1478 <loop+0x34>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	29450513          	addi	a0,a0,660 # 1458 <loop+0x14>
     ...
     1f0:	2d450513          	addi	a0,a0,724 # 14c0 <loop+0x7c>
     ...
     212:	2c250513          	addi	a0,a0,706 # 14d0 <loop+0x8c>
     ...
     256:	23e50513          	addi	a0,a0,574 # 1490 <loop+0x4c>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE | O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	28250513          	addi	a0,a0,642 # 14e8 <loop+0xa4>
     ...
     282:	27a50513          	addi	a0,a0,634 # 14f8 <loop+0xb4>
     ...
     294:	27050513          	addi	a0,a0,624 # 1500 <loop+0xbc>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE | O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	26450513          	addi	a0,a0,612 # 1508 <loop+0xc4>
     ...
     2c0:	25c50513          	addi	a0,a0,604 # 1518 <loop+0xd4>
     ...
     2d2:	21250513          	addi	a0,a0,530 # 14e0 <loop+0x9c>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	1da58593          	addi	a1,a1,474 # 14b8 <loop+0x74>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	23a50513          	addi	a0,a0,570 # 1520 <loop+0xdc>
     ...
     2fc:	24050513          	addi	a0,a0,576 # 1538 <loop+0xf4>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	1b858593          	addi	a1,a1,440 # 14c0 <loop+0x7c>
     310:	00001517          	auipc	a0,0x1
     314:	23850513          	addi	a0,a0,568 # 1548 <loop+0x104>
     ...
     348:	20c50513          	addi	a0,a0,524 # 1550 <loop+0x10c>
     ...
     396:	1be50513          	addi	a0,a0,446 # 1550 <loop+0x10c>
     ...
     3a8:	a8a080e7          	jalr	-1398(ra) # e2e <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <loop+0x337>
     ...
     3f6:	17650513          	addi	a0,a0,374 # 1568 <loop+0x124>
     ...
     422:	11250513          	addi	a0,a0,274 # 1530 <loop+0xec>
     ...
     444:	11050513          	addi	a0,a0,272 # 1550 <loop+0x10c>
     ...
     45e:	11e50513          	addi	a0,a0,286 # 1578 <loop+0x134>
     ...
     4ac:	0a850513          	addi	a0,a0,168 # 1550 <loop+0x10c>
     ...
     508:	08c50513          	addi	a0,a0,140 # 1590 <loop+0x14c>
     ...
     534:	07858593          	addi	a1,a1,120 # 15a8 <loop+0x164>
     ...
     636:	f1e50513          	addi	a0,a0,-226 # 1550 <loop+0x10c>
     ...
     650:	fa450513          	addi	a0,a0,-92 # 15f0 <loop+0x1ac>
     ...
     664:	f9050513          	addi	a0,a0,-112 # 15f0 <loop+0x1ac>
     ...
     67c:	f3058593          	addi	a1,a1,-208 # 15a8 <loop+0x164>
     ...
     6ee:	f2650513          	addi	a0,a0,-218 # 1610 <loop+0x1cc>
     ...
     708:	f2450513          	addi	a0,a0,-220 # 1628 <loop+0x1e4>
     ...
     724:	f2050513          	addi	a0,a0,-224 # 1640 <loop+0x1fc>
     ...
     73e:	f2e50513          	addi	a0,a0,-210 # 1668 <loop+0x224>
     ...
     826:	ee658593          	addi	a1,a1,-282 # 1708 <loop+0x2c4>
     ...
     84a:	eca50513          	addi	a0,a0,-310 # 1710 <loop+0x2cc>
     ...
     864:	d3058593          	addi	a1,a1,-720 # 1590 <loop+0x14c>
     868:	4509                	li	a0,2
     ...
     880:	d1458593          	addi	a1,a1,-748 # 1590 <loop+0x14c>
     884:	4509                	li	a0,2
     ...
     8dc:	db858593          	addi	a1,a1,-584 # 1690 <loop+0x24c>
     8e0:	4509                	li	a0,2
     ...
     950:	c0458593          	addi	a1,a1,-1020 # 1550 <loop+0x10c>
     954:	4509                	li	a0,2
     ...
     99c:	cf858593          	addi	a1,a1,-776 # 1690 <loop+0x24c>
     9a0:	4509                	li	a0,2
     ...
     9e0:	cb458593          	addi	a1,a1,-844 # 1690 <loop+0x24c>
     9e4:	4509                	li	a0,2
     ...
     a48:	b0c58593          	addi	a1,a1,-1268 # 1550 <loop+0x10c>
     a4c:	4509                	li	a0,2
...
void iter() {
  ...
  unlink("a");
     ...
     a70:	ac450513          	addi	a0,a0,-1340 # 1530 <loop+0xec>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	a6450513          	addi	a0,a0,-1436 # 14e0 <loop+0x9c>
  ...
  if (pid1 == 0) {
    ...
    printf("grind: fork failed\n");
     ...
     aba:	a9a50513          	addi	a0,a0,-1382 # 1550 <loop+0x10c>
  ...
  if (pid2 == 0) {
    ...
    rand_next ^= 7177;
     ...
     ae8:	629c                	ld	a5,0(a3)
     aea:	6709                	lui	a4,0x2
     aec:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x411>
    ...
    printf("grind: fork failed\n");
     ...
     b02:	a5250513          	addi	a0,a0,-1454 # 1550 <loop+0x10c>
...
static void printint(int fd, int xx, int base, int sgn) {
  ...
  do {
    buf[i++] = digits[x % base];
     ...
     f26:	8d650513          	addi	a0,a0,-1834 # 17f8 <digits>
     f2a:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
  ...
  state = 0;
     ...
     fe6:	7bec8c93          	addi	s9,s9,1982 # 17a0 <loop+0x35c>
      } else if (c == 'p') {
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     ff4:	808b8b93          	addi	s7,s7,-2040 # 17f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    111a:	68298993          	addi	s3,s3,1666 # 1798 <loop+0x354>
        while (*s != 0) {
    111e:	85ee                	mv	a1,s11
...
0000000000001356 <dump_test2_asm>:
#include "kernel/syscall.h"
...
0000000000001372 <dump_test3_asm>:
...
dump_test3_asm:
  ...
  li s3, -12
    1374:	59d1                	li	s3,-12
  li s4, 123
    1376:	07b00a13          	li	s4,123
  li s5, -1234
    137a:	b2e00a93          	li	s5,-1234
  li s6, 12345
    137e:	6b0d                	lui	s6,0x3
    1380:	039b0b1b          	addiw	s6,s6,57 # 3039 <base+0xc31>
  li s7, -123456
    1384:	7b89                	lui	s7,0xfffe2
    1386:	dc0b8b9b          	addiw	s7,s7,-576 # fffffffffffe1dc0 <base+0xfffffffffffdf9b8>
  li s8, 1234567
    138a:	0012dc37          	lui	s8,0x12d
    138e:	687c0c1b          	addiw	s8,s8,1671 # 12d687 <base+0x12b27f>
  li s9, -12345678
    1392:	ff43acb7          	lui	s9,0xff43a
    1396:	eb2c8c9b          	addiw	s9,s9,-334 # ffffffffff439eb2 <base+0xffffffffff437aaa>
  li s10, 123456789
    139a:	075bdd37          	lui	s10,0x75bd
    139e:	d15d0d1b          	addiw	s10,s10,-747 # 75bcd15 <base+0x75ba90d>
  li s11, -1234567890
    13a2:	b66a0db7          	lui	s11,0xb66a0
    13a6:	d2ed8d9b          	addiw	s11,s11,-722 # ffffffffb669fd2e <base+0xffffffffb669d926>
#ifdef SYS_dump
  li a7, SYS_dump
    13aa:	48d9                	li	a7,22
  ecall
...
00000000000013b2 <dump_test4_asm>:
.globl dump_test4_asm
dump_test4_asm:
  li s2, 2147483647
    13b2:	80000937          	lui	s2,0x80000
    13b6:	397d                	addiw	s2,s2,-1 # 7fffffff <base+0x7fffdbf7>
  li s3, -2147483648
    13b8:	800009b7          	lui	s3,0x80000
  li s4, 1337
    13bc:	53900a13          	li	s4,1337
  li s5, 2020
    13c0:	7e400a93          	li	s5,2020
  li s6, 3234
    13c4:	6b05                	lui	s6,0x1
    13c6:	ca2b0b1b          	addiw	s6,s6,-862 # ca2 <gets+0x28>
  li s7, 3235
    13ca:	6b85                	lui	s7,0x1
    13cc:	ca3b8b9b          	addiw	s7,s7,-861 # ca3 <gets+0x29>
  li s8, 3236
    13d0:	6c05                	lui	s8,0x1
    13d2:	ca4c0c1b          	addiw	s8,s8,-860 # ca4 <gets+0x2a>
  li s9, 3237
    13d6:	6c85                	lui	s9,0x1
    13d8:	ca5c8c9b          	addiw	s9,s9,-859 # ca5 <gets+0x2b>
  li s10, 3238
    13dc:	6d05                	lui	s10,0x1
    13de:	ca6d0d1b          	addiw	s10,s10,-858 # ca6 <gets+0x2c>
  li s11, 3239
    13e2:	6d85                	lui	s11,0x1
    13e4:	ca7d8d9b          	addiw	s11,s11,-857 # ca7 <gets+0x2d>
#ifdef SYS_dump
  li a7, SYS_dump
    13e8:	48d9                	li	a7,22
  ecall
...
00000000000013f0 <dump2_test1_asm>:
#include "kernel/syscall.h"
...
dump2_test1_asm:
  ...
  ecall
    1406:	00000073          	ecall
  j loop
    140a:	a82d                	j	1444 <loop>

000000000000140c <dump2_test2_asm>:
...
dump2_test2_asm:
  ...
  li s5, 25
    1412:	4ae5                	li	s5,25
  li s6, 36
    1414:	02400b13          	li	s6,36
  li s7, 49
    1418:	03100b93          	li	s7,49
  li s8, 64
    141c:	04000c13          	li	s8,64
  li s9, 81
    1420:	05100c93          	li	s9,81
  li s10, 100
    1424:	06400d13          	li	s10,100
  li s11, 121
    1428:	07900d93          	li	s11,121
  li a7, SYS_write
    142c:	48c1                	li	a7,16
  ecall
    142e:	00000073          	ecall
  j loop
    1432:	a809                	j	1444 <loop>

0000000000001434 <dump2_test3_asm>:

.globl dump2_test3_asm
dump2_test3_asm:
  li s2, 1337
    1434:	53900913          	li	s2,1337
  mv a2, a1
    1438:	862e                	mv	a2,a1
  li a1, 2
    143a:	4589                	li	a1,2
...
0000000000001444 <loop>:

loop:
  j loop
    1444:	a001                	j	1444 <loop>
  ret
    1446:	8082                	ret
